...
@section('title', trans('Sepet Hatırlatma'))
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-md-12 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">@trans(Sepet Hatırlatma)</h2>
    ...
    <div class="content-body">
        <section id="basic-datatable" class="table">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <table class="datatables-basic table" id="reminderTable">
                            <thead style="position: sticky; top: 0; z-index: 0">
                            <tr>
                                <th></th>
                                <th>@trans(Sıra)</th>
                                <th>@trans(Adı Soyadı)</th>
                                <th>@trans(Sepet Tarihi)</th>
                                <th>@trans(E-posta Durumu)</th>
                                <th>@trans(Hatırlat)</th>
                            </tr>
                            </thead>
                        </table>
                    </div>
