    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">@trans(Kuponlar)</h2>
        ...
        <div class="col-md-3 text-end">
            <button class="btn btn-primary" id="newCoupon">@trans(Yeni Kupon)</button>
        </div>
    </div>
                    ...
                    <div class="card">
                        <table class="datatables-basic table" id="couponTable">
                            ...
                            <tr>
                                <th></th>
                                <th>@trans(Sıra)</th>
                                <th>@trans(Kupon Kodu)</th>
                                <th>@trans(Kupon Adı)</th>
                                <th>@trans(İndirim Oranı / Miktarı)</th>
                                <th>@trans(Geçerlilik Tutarı)</th>
                                <th>@trans(Durum)</th>
...
<script src="{{themeAssets('assets/js/pages/coupons.js')}}"></script>
@endsection