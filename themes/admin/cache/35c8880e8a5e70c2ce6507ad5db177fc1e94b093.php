<?php $__env->startSection('title', trans('Kullanıcılar')); ?>
<?php $__env->startSection('content'); ?>
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0"><?php echo trans("Kullanıcılar") ?></h2>
        ...
        <div class="col-md-3 text-end">
            <button class="btn btn-primary"
                    id="newUserButton"><?php echo trans("Yeni Kullanıcı") ?></button>
        </div>
    </div>
                    ...
                    <div class="card">
                        <table class="datatables-basic table" id="user-datatable">
                            ...
                            <tr>
                                ...
                                <th><?php echo trans("Profil") ?></th>
                                <th><?php echo trans("Ad Soyad") ?></th>
                                <th><?php echo trans("E-Posta") ?></th>
                                <th><?php echo trans("Yetki") ?></th>
...
<script src="<?php echo e(themeAssets('assets/js/pages/users.js')); ?>"></script>
<?php $__env->stopSection(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bekir/Desktop/admin/themes/admin/views/user/users.blade.php ENDPATH**/ ?>