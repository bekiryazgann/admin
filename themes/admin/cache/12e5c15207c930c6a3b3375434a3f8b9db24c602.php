<?php $__env->startSection('title', trans('Sayfalar')); ?>
<?php $__env->startSection('content'); ?>
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0"><?php echo trans("Sayfalar") ?></h2>
        ...
        <div class="col-md-3 text-end">
            <a class="btn btn-primary"
               href="<?php echo e(siteUrl('contents/pages/new-page')); ?>"
               id="newBrand"><?php echo trans("Yeni Sayfa") ?></a>
        </div>
    </div>
                    ...
                    <div class="card">
                        <table class="datatables-basic table" id="page-datatable">
                            ...
                            <tr>
                                ...
                                <th><?php echo trans("Sayfa Başlığı") ?></th>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(themeAssets('assets/js/pages/pages.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bekir/Desktop/admin/themes/admin/views/contents/pages.blade.php ENDPATH**/ ?>