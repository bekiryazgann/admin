<?php
	...
	class Upload
	{
		 ...
		 * @return $this
		 */
		public function resize($width, $height = null, $crop = true): Upload
		{
		 ...
		 * @return $this
		 */
		public function convert($ext): Upload
		{
		 ...
		 * @return $this
		 */
		public function watermark($text = null): Upload
		{
			if ($text) {
		 ...
		 * @return $this
		 */
		public function prefix($prefix): Upload
		{
