    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">@trans(Slider Ayarları)</h2>
        ...
        <div class="col-md-3 text-end">
            <a class="btn btn-primary" href="{{siteUrl('design-settings/slider-settings/new-slider')}}"> Yeni Slider </a>
        </div>
    </div>
...
@section('scripts')
    ...
    <script src="{{themeAssets('assets/js/pages/slider-settings.js')}}"></script>
@endsection