<div class="offcanvas-header">
    <h5 id="offcanvasEndLabel" class="offcanvas-title">Kupon Ekle</h5>
    <button type="button"
            ...
            <div class="col-12">
                <div class="mb-1">
                    ...
                    <select name="coupon_type" id="coupon-type" class="form-select">
                        <option value="1" selected><?php echo trans("Yüzde Bazlı") ?></option>
                        <option value="2"><?php echo trans("Birim Bazlı") ?></option>
                    </select>
                </div>
            </div>
...
<script>
    ...
    $('#newCouponForm').on('submit', function (e) {
        $.post(url + 'api/newCoupon', $(this).serialize(), function (response) {
            if (response.error) {
...
</script><?php /**PATH /Users/bekir/Desktop/admin/themes/admin/views/modals/new-coupon.blade.php ENDPATH**/ ?>