...
<head>
    ...
    <meta name="description" content="Socore Dijital Sistemler Yeni Hesap Oluşturma Sayfası. Socore'a Kayıt Ol">
    <meta name="keywords" content="socore, dijital, sistemler, digital, systems">
    <meta name="author" content="Ebubekir Yazgan">
    <title><?php echo trans("Yeni Hesap Oluştur") ?> - <?php echo trans("Socore Dijital Sistemler") ?></title>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(themeAssets('app-assets/vendors/css/forms/wizard/bs-stepper.min.css')); ?>">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(themeAssets('app-assets/css/plugins/forms/form-wizard.css')); ?>">
        ...
        <div class="content-body">
            <div class="auth-wrapper auth-cover">
                <div class="auth-inner row m-0">
                    <a class="brand-logo" href="<?php echo e(siteUrl('auth/register')); ?>">
                        <svg version="1.1"
                             id="Layer_1"
                    ...
                    <div class="col-lg-3 d-none d-lg-flex align-items-center p-0">
                        <div class="w-100 d-lg-flex align-items-center justify-content-center">
                            <img class="img-fluid w-100"
                                 src="<?php echo e(themeAssets('app-assets/images/illustration/create-account.svg')); ?>"
                                 alt="multi-steps"/>
                        </div>
                    </div>
                        ...
                        <div class="width-700 mx-auto">
                            <form action="" method="post" autocomplete="off">
                                ...
                                <div class="bs-stepper register-multi-steps-wizard shadow-none">
                                    <div class="bs-stepper-header px-0"
                                         role="tablist">
                                        <div class="step"
                                            ...
                                            <button type="button" class="step-trigger">
                                                ...
                                                <span class="bs-stepper-label">
                                                    <span class="bs-stepper-title"><?php echo trans("Hesap") ?></span>
                                                    <span class="bs-stepper-subtitle"><?php echo trans("Hesap Bilgileriniz") ?></span>
                                                </span>
                                            </button>
                                        </div>
                                        <div class="line">
                                        ...
                                        <div class="step" data-target="#personal-info" role="tab"
                                            ...
                                            <button type="button" class="step-trigger">
                                                ...
                                                <span class="bs-stepper-label">
                                                    <span class="bs-stepper-title"><?php echo trans("Kurumsal") ?></span>
                                                    <span class="bs-stepper-subtitle"><?php echo trans("Kurumsal Biglileriniz") ?></span>
                                                </span>
                                            </button>
                                        </div>
                                    </div>
                                    <div class="bs-stepper-content px-0 mt-4">
                                        ...
                                        <div id="account-details" class="content" role="tabpanel"
                                            ...
                                            <div class="content-header mb-2">
                                                <h2 class="fw-bolder mb-75"><?php echo trans("Hesap Bilgileri") ?></h2>
                                                <span><?php echo trans("Kullanıcı Bilgilerinizi Girin") ?></span>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6 mb-1">
                                                    <label class="form-label"
                                                           for="username"><?php echo trans("Kullanıcı Adı") ?></label>
                                                    <input type="text"
                                                           name="username"
                                                           id="username"
                                                           class="form-control"
                                                           placeholder="<?php echo trans("mertucar") ?>"/>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    <label class="form-label" for="email"><?php echo trans("E-posta") ?></label>
                                                    <input type="email"
                                                           name="email"
                                                           id="email"
                                                           class="form-control"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-1">
                                                    <label class="form-label" for="password"><?php echo trans("Parola") ?></label>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    <label class="form-label"
                                                           for="confirm-password"><?php echo trans("Yeniden Parola") ?></label>
                                                    <div class="input-group input-group-merge form-password-toggle">
                                                        <input type="password"
                                                    ...
                                                    <?php if (isset($errors['confirm-password'])): ?><div class="row"><div class="col-12"><div class="alert alert-danger mt-1" style="padding: 10px 12px"><?=$errors['confirm-password'][0]?></div></div></div><?php endif; ?>
                                                </div>

                                                <div class="col-12 mb-1">
                                                    <label class="form-label" for="page_name"><?php echo trans("Sayfa Adı") ?></label>
                                                    <div class="input-group input-group-merge">
                                                        <span class="input-group-text text-primary" style="padding-right: 0!important">https://</span>
                                                        <input type="text" class="form-control page_name" name="page_name"
                                                               id="page_name">
                                                        <span class="input-group-text text-primary">.mysocore.app</span>
                                                    </div>
                                                    <?php if (isset($errors['page_name'])): ?><div class="row"><div class="col-12"><div class="alert alert-danger mt-1" style="padding: 10px 12px"><?=$errors['page_name'][0]?></div></div></div><?php endif; ?>
                                                </div>
                                                ...
                                                <div class="col-12 mb-1 d-flex justify-content-between align-items-center">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="multiStepsRememberMe">
                                                            <?php echo trans("Beni Hatırla") ?>
                                                        </label>
                                                    </div>
                                                    <div>
                                                        <?php echo trans("Hesabın var mı?") ?> <a href="<?php echo e(siteUrl('auth/login')); ?>"><?php echo trans("Giriş Yap!") ?></a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex justify-content-between mt-2">
                                                <button class="btn btn-outline-secondary btn-prev" disabled
                                                    ...
                                                    <span class="align-middle d-sm-inline-block d-none"><?php echo trans("Geri") ?></span>
                                                </button>
                                                <button class="btn btn-primary btn-next" type="button">
                                                    <span class="align-middle d-sm-inline-block d-none"><?php echo trans("İleri") ?></span>
                                        ...
                                        <div id="personal-info" class="content" role="tabpanel"
                                            ...
                                            <div class="content-header mb-2">
                                                <h2 class="fw-bolder mb-75"><?php echo trans("Kişisel Bilgiler") ?></h2>
                                                <span><?php echo trans("Kişisel bilgilerinizi girin.") ?></span>
                                            </div>
                                            <div class="row">
                                                <div class="mb-1 col-md-6">
                                                    <label class="form-label" for="firstname"><?php echo trans("Adınız") ?></label>
                                                    <input type="text"
                                                           name="firstname"
                                                           id="firstname"
                                                           class="form-control"
                                                ...
                                                <div class="mb-1 col-md-6">
                                                    <label class="form-label" for="lastname"><?php echo trans("Soyadınız") ?></label>
                                                    <input type="text"
                                                           name="lastname"
                                                           id="lastname"
                                                           class="form-control"
                                                ...
                                                <div class="col-md-12 mb-1">
                                                    <label class="form-label" for="phone"><?php echo trans("Telefon") ?></label>
                                                    <input type="text"
                                                           name="phone"
                                                           id="phone"
                                                           class="form-control"
                                                           placeholder="0552 732 11 36"/>
                                                ...
                                                <div class="col-12 mb-1">
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           id="address"
                                                           class="form-control"
                                                           placeholder="Cemal Paşa Mh. Cumhuriyet Cd. Kemal Paşa Sk. No:88 D:2"/>
                                            ...
                                            <div class="d-flex justify-content-between mt-2">
                                                ...
                                                <button class="btn btn-primary btn-next" type="submit">
                                                    <span class="align-middle d-sm-inline-block d-none"><?php echo trans("Kaydol") ?></span>
                                                    <i data-feather="chevron-right"
                                                       class="align-middle ms-sm-25 ms-0"></i>
                                                </button>
                                            </div>
...
<script src="<?php echo e(themeAssets('app-assets/vendors/js/forms/wizard/bs-stepper.min.js')); ?>"></script>
...
<script src="<?php echo e(themeAssets('app-assets/vendors/js/forms/cleave/addons/cleave-phone.us.js')); ?>"></script>
...
<script src="<?php echo e(themeAssets('app-assets/js/scripts/pages/auth-register.js')); ?>"></script>
<script>
    <?php if(cookie('msg')): ?>
        toastr['info']("<?php echo cookie('msg'); ?>", "<?php echo trans("Bilgi") ?>", {
        closeButton: true,
        tapToDismiss: false,
        rtl: false
    });
    <?php endif; ?>
    $(window).on("load", function () {feather && feather.replace({width: 14, height: 14})});
    $(function () {$('input#username, input#email, input#page_name, input#phone').on('keydown', function (){let t = $(this);setTimeout(function () {let n = t.attr('name'), v = t.val();$.ajax({url: '<?php echo e(siteUrl('api/first-and-only')); ?>', method: 'POST', data: {'fieldName': n, 'fieldValue': v}, success: function (response) {if(response.count === 1){if(t.hasClass('page_name')){t.parent().addClass('border-danger rounded');} else {t.addClass('border-danger');}} else {if(t.hasClass('page_name')){t.parent().removeClass('border-danger rounded');} else {t.removeClass('border-danger');}}}});}, 50);});});
</script>
</body>
</html><?php /**PATH /Users/bekir/Desktop/admin/themes/admin/views/auth/register.blade.php ENDPATH**/ ?>