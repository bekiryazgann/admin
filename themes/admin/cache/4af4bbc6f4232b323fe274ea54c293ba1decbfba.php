<?php $__env->startSection('title', 'Ödeme Ayarları'); ?>
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <select name="visitor_shopping" id="visitor_shopping" class="form-select" >
                                <option value="0" <?php if($paymentPref->visitor_shopping == 0): ?> selected <?php endif; ?>> Müşteri üye olmadan alışveriş yapmasın</option>
                                <option value="1"  <?php if($paymentPref->visitor_shopping == 1): ?> selected <?php endif; ?>> Müşteri üye olmadan alışveriş yapsın</option>
                            </select>
                        </div>
                        <div class="col-6">
                            ...
                            <select name="phone_information" id="phone_information" class="form-select">
                                <option value="0" <?php if($paymentPref->phone_information == 0): ?> selected <?php endif; ?>> İsteğe Bağlı</option>
                                <option value="1" <?php if($paymentPref->phone_information == 1): ?> selected <?php endif; ?>> Zorunlu</option>
                            </select>
                        </div>
                        <div class="col-6">
                            ...
                            <select name="distance_selling_contract" id="distance_selling_contract" class="form-select">
                                <option value="1" <?php if($paymentPref->distance_selling_contract == 1): ?> selected <?php endif; ?>> Onay kutusu göster, otomatik onaylanmış gelsin.</option>
                                <option value="0" <?php if($paymentPref->distance_selling_contract == 0): ?> selected <?php endif; ?>> Onay kutusu göster, müşteri onaylasın.</option>
                            </select>
                        </div>
                        <div class="col-6">
                            <label for="post_code" class="form-label"> Posta Kodu </label>
                            <select name="post_code" id="post_code" class="form-select">
                                <option value="0" <?php if($paymentPref->post_code == 0): ?> selected <?php endif; ?>> İsteğe Bağlı</option>
                                <option value="1" <?php if($paymentPref->post_code == 1): ?> selected <?php endif; ?>> Zorunlu</option>
                            </select>
                        </div>
                        <div class="col-6">
                            <label for="gift_wrap" class="form-label"> Hediye Paketi </label>
                            <select name="gift_wrap" id="gift_wrap" class="form-select">
                                <option value="1" <?php if($paymentPref->gift_wrap == 1): ?> selected <?php endif; ?>> Göster</option>
                                <option value="0" <?php if($paymentPref->gift_wrap == 0): ?> selected <?php endif; ?>> Gizle</option>
                            </select>
                        </div>
                        <div class="col-6">
                            <label for="order_note" class="form-label"> Sipariş Notu </label>
                            <select name="order_note" id="order_note" class="form-select">
                                <option value="0" <?php if($paymentPref->order_note == 0): ?> selected <?php endif; ?>> Göster </option>
                                <option value="1" <?php if($paymentPref->order_note == 1): ?> selected <?php endif; ?>> Gizle </option>
                            </select>
                        </div>
                        <div class="col-6">
                            <label for="tc_no" class="form-label"> TC Kimlik No </label>
                            <select name="tc_no" id="tc_no" class="form-select">
                                <option value="1" <?php if($paymentPref->tc_no == 1): ?> selected <?php endif; ?>> Gizle </option>
                                <option value="0" <?php if($paymentPref->tc_no == 0): ?> selected <?php endif; ?>> Zorunlu </option>
                            </select>
                        </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="dropdown-menu dropdown-menu-end" style="" id="dropdown">
                    <?php if(!in_array('eft', $addedPaymentMethods)): ?>
                    ...
                    <?php endif; ?>
                    <?php if(!in_array('credit-card', $addedPaymentMethods)): ?>
                        <a class="dropdown-item"
                           href="#credit-cart"
                           aria-selected="false">
                    ...
                    <?php endif; ?>
                    <?php if(!in_array('cash', $addedPaymentMethods)): ?>
                        <a class="dropdown-item"
                           href="#cash"
                           aria-selected="false">
                    ...
                    <?php endif; ?>
                    <?php if(!in_array('iyzico', $addedPaymentMethods)): ?>
                        <a class="dropdown-item"
                           href="#iyzico"
                           aria-selected="false">
                    ...
                    <?php endif; ?>
                    <?php if(!in_array('paytr', $addedPaymentMethods)): ?>
                        <a class="dropdown-item"
                           href="#paytr"
                           aria-selected="false">
                    ...
                    <?php endif; ?>
                    <?php if(!in_array('param', $addedPaymentMethods)): ?>
                        <a class="dropdown-item"
                           href="#param"
                           aria-selected="false">
                    ...
                    <?php endif; ?>
                    <?php if(!in_array('stripe', $addedPaymentMethods)): ?>
                        <a class="dropdown-item"
                           href="#stripe"
                           aria-selected="false">
                    ...
                    <?php endif; ?>
                    <?php if(!in_array('paypal', $addedPaymentMethods)): ?>
                        <a class="dropdown-item"
                           href="#paypal"
                           aria-selected="false">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-removeid="<?php echo e($val->id); ?>">
                                <td>
                                    <?php echo match ($val->service){
                                ...
                                <td style="width: 20%;">
                                    ...
                                    <button class="btn btn-outline-danger ms-1 btn-icon" data-id="<?php echo e($val->id); ?>" data-role="remove-payment">
...
<?php $__env->startSection('scripts'); ?>
    <script src="<?php echo e(themeAssets('assets/js/pages/payment-settings.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bekir/Desktop/admin/themes/admin/views/settings/payment-settings.blade.php ENDPATH**/ ?>