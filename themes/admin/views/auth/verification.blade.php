...
<head>
    ...
    <title>E-posta Doğrulama - Socore Dijital Sistemler</title>
                ...
                <div class="auth-inner row m-0">
                    ...
                    <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                        <div class="w-100 d-lg-flex align-items-center justify-content-center px-5">
                            <img class="img-fluid" src="{{themeAssets('app-assets/images/illustration/two-steps-verification-illustration-dark.svg')}}" alt="two steps verification" />
                        </div>
                    </div>
                    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            <h2 class="card-title fw-bolder mb-1">E-postanızı Doğrulayın &#x1F4AC;</h2>
                            <p class="card-text mb-75">Aşağıdaki E-posta adresine bir doğrulama kodu gönderdik. E-posta adresinize gelen kodu aşağıdaki alana girin.</p>
                            <p class="card-text fw-bolder mb-2">{{$email}}</p>
                            <form class="mt-2" action="" method="POST">
                                <h6>6 Haneli tek kullanımlık onay kodunu girinniz.</h6>
                                <div class="auth-input-wrapper d-flex align-items-center justify-content-between">
                                    <input class="form-control auth-input height-50 text-center numeral-mask mx-25 mb-1" name="vrfct_1" type="text" maxlength="1" autofocus="" />
                                    <input class="form-control auth-input height-50 text-center numeral-mask mx-25 mb-1" name="vrfct_2" type="text" maxlength="1" />
                                    <input class="form-control auth-input height-50 text-center numeral-mask mx-25 mb-1" name="vrfct_3" type="text" maxlength="1" />
                                    <input class="form-control auth-input height-50 text-center numeral-mask mx-25 mb-1" name="vrfct_4" type="text" maxlength="1" />
                                    <input class="form-control auth-input height-50 text-center numeral-mask mx-25 mb-1" name="vrfct_5" type="text" maxlength="1" />
                                    <input class="form-control auth-input height-50 text-center numeral-mask mx-25 mb-1" name="vrfct_6" type="text" maxlength="1" />
                                </div>
                                <button class="btn btn-primary w-100" type="submit" tabindex="4">Hesabımı Doğrula</button>
                            </form>
                        </div>
                    </div>
                </div>
...
<script src="{{themeAssets('app-assets/js/scripts/pages/auth-two-steps.js')}}"></script>
<script>
