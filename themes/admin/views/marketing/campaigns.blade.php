    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">@trans(Kampanyalar)</h2>
        ...
        <div class="col-md-3 text-end">
            <button class="btn btn-primary" id="newCampaign">@trans(Yeni Kampanya)</button>
        </div>
    </div>
                    ...
                    <div class="card">
                        <table class="datatables-basic table" id="couponTable">
                            ...
                            <tr>
                                <th></th>
                                <th>@trans(Sıra)</th>
                                <th>@trans(Kampanya Adı)</th>
                                <th>@trans(Kampanya TÜrü)</th>
                                <th>@trans(İndirim Miktarı)</th>
                                <th>@trans(Durum)</th>
...
<script src="{{themeAssets('assets/js/pages/campaigns.js')}}"></script>
@endsection