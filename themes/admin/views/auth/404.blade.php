...
<head>
    ...
    <title>Hata - {{sysConfig('SYS_TITLE_PREFIX')}}</title>
            ...
            <div class="misc-wrapper">
                ...
                <div class="misc-inner p-2 p-sm-3">
                    <div class="w-100 text-center">
                        <h2 class="mb-1">@trans(Sayfa Bulunamadı 🕵🏻‍♀️)</h2>
                        <p class="mb-2">@trans(Hata! 😖 İstenen URL sunucuda bulunamadı.)</p>
                        @isset($_SERVER['HTTP_REFERER'])
                            <a class="btn btn-primary mb-2 btn-sm-block"
                               href="{{$_SERVER['HTTP_REFERER']}}">@trans(Geri Dön)</a>
                        @endisset
                        <img class="img-fluid" src="{{themeAssets('app-assets/images/pages/error-dark.svg')}}"
                             alt="Error page" />
                    </div>
                </div>
            </div>
