<?php $__env->startSection('title', trans('Markalar')); ?>
    ...
    <div class="content-header row">
        ...
        <div class="col-md-3 text-end">
            <button class="btn btn-primary"
                    id="newBrand"><?php echo trans("Yeni Marka") ?></button>
        </div>
    </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(themeAssets('assets/js/pages/brands.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bekir/Desktop/admin/themes/admin/views/catalog/brands.blade.php ENDPATH**/ ?>