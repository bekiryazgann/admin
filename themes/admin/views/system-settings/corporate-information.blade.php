                    ...
                    <div class="col-8">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title"> @trans(Firma Bilgileri) </h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="mb-1 row">
                                            <label for="company_name"
                                                   class="col-sm-12 form-label">@trans(Firma Adı)</label>
                                            <div class="col-12">
                                                <input type="text"
                                                       class="form-control"
                                                       id="company_name"
                                    ...
                                    <div class="col-6">
                                        <div class="mb-1 row">
                                            <label for="company_official_name"
                                                   class="col-sm-12 form-label">@trans(Firma Resmi Adı)</label>
                                            <div class="col-12">
                                                <input type="text"
                                                       class="form-control"
                                                       id="company_official_name"
                                                       name="company_official_name"
                                                       value="{{$data->company_official_name}}"
                                                       placeholder="@trans(Socore Dijital Sistemler Teknoloji LTD. ŞTİ.)">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            <label for="authorized_person"
                                                   class="col-sm-12 form-label">@trans(Yetkili Kişi)</label>
                                            <div class="col-12">
                                                <input type="text"
                                                       class="form-control"
                                    ...
                                    <div class="col-6">
                                        <div class="mb-1 row">
                                            <label for="phone_number"
                                                   class="col-sm-12 form-label">@trans(Telefon No)</label>
                                            <div class="col-12">
                                                <input type="text"
                                                       class="form-control"
                                                       id="phone_number"
                                                       ...
                                                       placeholder="@trans(+90 532 611 11 29)">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-1 row">
                                            <label for="fax"
                                                   class="col-sm-12 form-label">@trans(Faks)</label>
                                            <div class="col-12">
                                                <input type="text"
                                                       class="form-control"
                                                       id="fax"
                                    ...
                                    <div class="col-3">
                                        <div class="mb-1 row">
                                            <label for="country"
                                                   class="col-sm-12 form-label">@trans(Ülke)</label>
                                            <div class="col-12">
                                                <input type="text"
                                                       class="form-control"
                                                       id="country"
                                    ...
                                    <div class="col-3">
                                        <div class="mb-1 row">
                                            <label for="city"
                                                   class="col-sm-12 form-label">@trans(Şehir)</label>
                                            <div class="col-12">
                                                <input type="text"
                                                       class="form-control"
                                                       id="city"
                                    ...
                                    <div class="col-3">
                                        <div class="mb-1 row">
                                            <label for="district"
                                                   class="col-sm-12 form-label">@trans(İlçe)</label>
                                            <div class="col-12">
                                                <input type="text"
                                                       class="form-control"
                                                       id="district"
                                    ...
                                    <div class="col-3">
                                        <div class="mb-1 row">
                                            <label for="post_code"
                                                   class="col-sm-12 form-label">@trans(Posta Kodu)</label>
                                            <div class="col-12">
                                                <input type="text"
                                                       class="form-control"
                                                       id="post_code"
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            <label for="address"
                                                   class="form-label col-sm-12">@trans(Açık Adres)</label>
                                            <div class="col-12">
                                                <textarea class="form-control"
                                                          id="address"
                                                          name="address"
                                                          placeholder="Atatürk mah. Hülagü han Cd. Çamoğlu Sk. No:2 D:2 Kadıköy/İstanbul">{{$data->address}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title"> @trans(Firma E-Posta Bilgileri) </h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            <label for="email"
                                                   class="col-sm-12 form-label">@trans(Kurumsal E-posta Adresi)</label>
                                            <div class="col-12">
                                                <input type="text"
                                                       class="form-control"
                                                       id="email"
                                                       name="email"
                                                       value="{{$data->email}}"
                                                       placeholder="@trans(info@socore.net)">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            <label for="b2c_email"
                                                   class="col-sm-12 form-label">@trans(B2C Müşteri E-Posta Adresi)</label>
                                            <div class="col-12">
                                                <input type="text"
                                                       class="form-control"
                                                       id="b2c_email"
                                                       name="b2c_email"
                                                       value="{{$data->b2c_email}}"
                                                       placeholder="@trans(b2c@socore.net)">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title"> @trans(Resmi Bilgiler) </h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            <label for="company_registration_number"
                                                   class="col-sm-12 form-label">@trans(Sicil No)</label>
                                            <div class="col-12">
                                                <input type="text"
                                                       class="form-control"
                                    ...
                                    <div class="col-6">
                                        <div class="mb-1 row">
                                            <label for="tax_administration"
                                                   class="col-sm-12 form-label">@trans(Vergi Dairesi)</label>
                                            <div class="col-12">
                                                <input type="text"
                                                       class="form-control"
                                                       id="tax_administration"
                                                       name="tax_administration"
                                                       value="{{$data->tax_administration}}"
                                                       placeholder="@trans(Kadıköy Vergi Dairesi)">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-1 row">
                                            <label for="tax_no"
                                                   class="col-sm-12 form-label">@trans(Vergi Numarası)</label>
                                            <div class="col-12">
                                                <input type="text"
                                                       class="form-control"
                                                       id="tax_no"
                                                       name="tax_no"
                                                       value="{{$data->tax_no}}"
                                                       placeholder="@trans(897645278253)">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            <label for="cap_address"
                                                   class="col-sm-12 form-label">@trans(Kep Adresi)</label>
                                            <div class="col-12">
                                                <input type="text"
                                                       class="form-control"
                                                       id="cap_address"
                                                       name="cap_address"
                                                       value="{{$data->cap_address}}"
                                                       placeholder="@trans(897645278253)">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            <label for="mersis_no"
                                                   class="col-sm-12 form-label">@trans(Mersis No)</label>
                                            <div class="col-12">
                                                <input type="text"
                                                       class="form-control"
                                                       id="mersis_no"
                                                       name="mersis_no"
                                                       value="{{$data->mersis_no}}"
                                                       placeholder="@trans(897645278253)">
                                            </div>
                                        </div>
                                    </div>
