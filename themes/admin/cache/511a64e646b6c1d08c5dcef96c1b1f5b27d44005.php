    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0"><?php echo trans("Siparişler") ?></h2>
                    ...
                    <div class="card">
                        <table class="datatables-basic table products-table">
                            ...
                            <tr>
                                ...
                                <th><?php echo trans("Sipariş Kodu") ?></th>
                                <th><?php echo trans("Adı Soyadı") ?></th>
                                <th><?php echo trans("Tarih") ?></th>
                                <th><?php echo trans("Tutar") ?></th>
    ...
    <script>
        $('.products-table').DataTable({
            ...
            lengthMenu: [
                ...
                [
                    '10 <?php echo trans("Adet") ?>',
                    '15 <?php echo trans("Adet") ?>',
                    '20 <?php echo trans("Adet") ?>',
                    '50 <?php echo trans("Adet") ?>',
                    '100 <?php echo trans("Adet") ?>',
                    '200 <?php echo trans("Adet") ?>',
                    '300 <?php echo trans("Adet") ?>',
                    '500 <?php echo trans("Adet") ?>',
                    '1000 <?php echo trans("Adet") ?>'
                ]
            ],
            processing: true,
            serverSide: true,
            ajax: {
                url: "<?php echo e(siteUrl('api/orders')); ?>",
                type: "POST"
            },
            columns: [
                {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bekir/Desktop/admin/themes/admin/views/orders/orders.blade.php ENDPATH**/ ?>