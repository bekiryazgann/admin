<?php $__env->startSection('title', 'Kuponlar'); ?>
<?php $__env->startSection('content'); ?>
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0"><?php echo trans("Kuponlar") ?></h2>
        ...
        <div class="col-md-3 text-end">
            <button class="btn btn-primary" id="newCoupon"><?php echo trans("Yeni Kupon") ?></button>
        </div>
    </div>
                    ...
                    <div class="card">
                        <table class="datatables-basic table" id="couponTable">
                            ...
                            <tr>
                                ...
                                <th><?php echo trans("Kupon Kodu") ?></th>
                                <th><?php echo trans("Kupon Adı") ?></th>
                                <th><?php echo trans("İndirim Oranı / Miktarı") ?></th>
                                <th><?php echo trans("Geçerlilik Tutarı") ?></th>
...
<script src="<?php echo e(themeAssets('assets/js/pages/coupons.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bekir/Desktop/admin/themes/admin/views/marketing/coupons.blade.php ENDPATH**/ ?>