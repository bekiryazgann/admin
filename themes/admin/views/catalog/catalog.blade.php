    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">@trans(Ürünler)</h2>
        ...
        <div class="col-md-3 text-end">
            <a class="btn btn-primary" href="{{siteUrl('catalog/products/new')}}">Yeni Ürün</a>
        </div>
    </div>
...
@section('scripts')
    ...
    <script src="{{themeAssets('assets/js/pages/catalog.js')}}"></script>
@endsection