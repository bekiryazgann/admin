<?php $__env->startSection('title', trans('Yeni Ürün')); ?>
<?php $__env->startSection('content'); ?>
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0"><?php echo trans("Yeni Ürün") ?></h2>
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-12 col-lg-12 col-xs-12 col-12 col-md-12">
                                        <select name="product_type" id="product-type" class="form-select">
                                            <option value="1"><?php echo trans("Fiziksel") ?></option>
                                            <option value="2"><?php echo trans("Dijital") ?></option>
                                        </select>
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-12 col-lg-12 col-xs-12 col-12 col-md-12">
                                        <select class="form-select" id="product-brand" name="product_brand">
                                            ...
                                            <option value="0"> - <?php echo trans("Yok") ?> -</option>
                                                ...
                                                <?php if($filter->status == 1): ?>
                                                    <optgroup label="<?php echo e($filter->name); ?>">
                                                        <?php $__currentLoopData = json_decode($filter->options, true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $options): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($filter->id . "@" . $key); ?>"><?php echo e($filter->name); ?> → <?php echo e($options); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </optgroup>
                                                <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-sm-12 col-lg-12 col-xs-12 col-12 col-md-12">
                                        <select class="tag-multi-select form-select" id="categories" multiple name="product_categories[]">
                                            <?php $__currentLoopData = listArray($categories); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key); ?>"><?php echo $category['name']; ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-12 col-lg-12 col-xs-12 col-12 col-md-12">
                                        <textarea type="text"
                                                  ...
                                                  placeholder="<?php echo trans("Ürün Özellikleri ve Detaylı Açıklaması") ?>"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-12 col-lg-12 col-xs-12 col-12 col-md-12 h-100">
                                            <textarea name="seo_description"
                                                      ...
                                                      style="resize: none"
                                                      id="seo-description"
                                                      placeholder="<?php echo trans("Açıklama") ?>"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-4">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bekir/Desktop/admin/themes/admin/views/catalog/new-product.blade.php ENDPATH**/ ?>