...
<head>
    ...
    <meta name="description" content="<?php echo e(sysConfig('SYS_DESCRIPTION')); ?>">
    <meta name="keywords" content="<?php echo e(sysConfig('SYS_KEYWORDS')); ?>">
    <meta name="author" content="<?php echo e(sysConfig('SYS_AUTHOR')); ?>">
    <title><?php echo $__env->yieldContent('title'); ?> - <?php echo e(sysConfig('SYS_TITLE_PREFIX')); ?></title>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(themeAssets('app-assets/css/fonts/montserrat/all.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(themeAssets('vendor.min.css')); ?>">
    <script src="<?php echo e(themeAssets('app-assets/css/plugins/tinymce/tinymce.min.js')); ?>"></script>
    <link rel="stylesheet" type="text/css" href="<?php echo e(themeAssets('assets/css/style.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(themeAssets('assets/css/web-builder-style.css')); ?>">
...
<?php echo $__env->make('web-builder.layouts.topNavbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow"
     data-scroll-to-active="true">
    <?php echo $__env->make('web-builder.layouts.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>
<div class="app-content content <?php echo $__env->yieldContent('contentClass'); ?>">
...
<?php echo $__env->make('web-builder.layouts.scripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('media.popup', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script src="<?php echo e(siteUrl('last-data-load')); ?>"></script>
...
<script src="<?php echo e(themeAssets('assets/js/util/iframe.js')); ?>"></script>
<script src="<?php echo e(themeAssets('assets/js/web-builder.js')); ?>"></script>
</body>
</html>
<?php /**PATH /Users/bekir/Desktop/admin/themes/admin/views/web-builder/layouts/layout.blade.php ENDPATH**/ ?>