...
@section('contentClass', 'email-application')
@section('content')
                        ...
                        <div class="sidebar-menu-list">
                            <div class="list-group list-group-messages">
                                <a href="#" class="list-group-item list-group-item-action active">
                                    ...
                                    <span class="align-middle"> @trans(Gelen Kutusu) </span>
                            ...
                            <div class="d-flex align-content-center justify-content-between w-100">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text"
                                           class="form-control"
                                           id="email-search"
                                           placeholder="@trans(Postalarda arayın)"
                                           aria-label="@trans(Postalarda arayın)"
                            ...
                            <ul class="email-media-list">
                                <li class="d-flex user-mail mail-read">
                                    <div class="mail-left pe-50">
                                        <div class="avatar">
                                            <img src="{{themeAssets('app-assets/images/portrait/small/avatar-s-20.jpg')}}"
                                ...
                                <li class="d-flex user-mail">
                                    <div class="mail-left pe-50">
                                        <div class="avatar">
                                            <img src="{{themeAssets('app-assets/images/portrait/small/avatar-s-17.jpg')}}"
                                ...
                                <li class="d-flex user-mail mail-read">
                                    <div class="mail-left pe-50">
                                        <div class="avatar">
                                            <img src="{{themeAssets('app-assets/images/portrait/small/avatar-s-7.jpg')}}"
                                                 alt="Generic placeholder image"/>
                                        </div>
                                        <div class="user-action">
                                            <div class="form-check">
                                ...
                                <li class="d-flex user-mail mail-read">
                                    <div class="mail-left pe-50">
                                        <div class="avatar">
                                            <img src="{{themeAssets('app-assets/images/portrait/small/avatar-s-5.jpg')}}"
                                                 alt="Generic placeholder image"/>
                                        </div>
                                        <div class="user-action">
                                            <div class="form-check">
                                ...
                                <li class="d-flex user-mail">
                                    <div class="mail-left pe-50">
                                        <div class="avatar">
                                            <img src="{{themeAssets('app-assets/images/portrait/small/avatar-s-3.jpg')}}"
                                                 alt="Generic placeholder image"/>
                                        </div>
                                        <div class="user-action">
                                            <div class="form-check">
                                ...
                                <li class="d-flex user-mail">
                                    <div class="mail-left pe-50">
                                        <div class="avatar">
                                            <img src="{{themeAssets('app-assets/images/portrait/small/avatar-s-8.jpg')}}"
                                                 alt="Generic placeholder image"/>
                                        </div>
                                        <div class="user-action">
                                            <div class="form-check">
                                ...
                                <li class="d-flex user-mail mail-read">
                                    <div class="mail-left pe-50">
                                        <div class="avatar">
                                            <img src="{{themeAssets('app-assets/images/portrait/small/avatar-s-11.jpg')}}"
                                                 alt="Generic placeholder image"/>
                                        </div>
                                        <div class="user-action">
                                            <div class="form-check">
                                ...
                                <li class="d-flex user-mail mail-read">
                                    <div class="mail-left pe-50">
                                        <div class="avatar">
                                            <img src="{{themeAssets('app-assets/images/portrait/small/avatar-s-10.jpg')}}"
                                                 alt="Generic placeholder image"/>
                                        </div>
                                        <div class="user-action">
                                            <div class="form-check">
                                ...
                                <li class="d-flex user-mail mail-read">
                                    <div class="mail-left pe-50">
                                        <div class="avatar">
                                            <img src="{{themeAssets('app-assets/images/portrait/small/avatar-s-6.jpg')}}"
                                                 alt="Generic placeholder image"/>
                                        </div>
                                        <div class="user-action">
                                            <div class="form-check">
                                ...
                                <li class="d-flex user-mail">
                                    <div class="mail-left pe-50">
                                        <div class="avatar">
                                            <img src="{{themeAssets('app-assets/images/portrait/small/avatar-s-9.jpg')}}"
                                                 alt="Generic placeholder image"/>
                                        </div>
                                        <div class="user-action">
                                            <div class="form-check">
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header email-detail-head">
                                            <div class="user-details d-flex justify-content-between align-items-center flex-wrap">
                                                <div class="avatar me-75">
                                                    <img src="{{themeAssets('app-assets/images/portrait/small/avatar-s-18.jpg')}}"
                                                         alt="avatar img holder" width="48" height="48"/>
                                                </div>
                                                <div class="mail-items">
                                        ...
                                        <div class="card-footer">
                                            <div class="mail-attachments">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <a href="#" class="mb-50">
                                                        <img src="{{themeAssets('app-assets/images/icons/doc.png')}}"
                                                             class="me-25" alt="png" height="18"/>
                                                        <small class="text-muted fw-bolder">interdum.docx</small>
                                                    </a>
                                                    <a href="#">
                                                        <img src="{{themeAssets('app-assets/images/icons/jpg.png')}}"
                                                             class="me-25" alt="png" height="18"/>
...
@section('styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{themeAssets('app-assets/css/plugins/forms/form-quill-editor.css')}}">
    <link rel="stylesheet" type="text/css" href="{{themeAssets('app-assets/css/plugins/extensions/ext-component-toastr.css')}}">
    <link rel="stylesheet" type="text/css" href="{{themeAssets('app-assets/css/pages/app-email.css')}}">
    <link rel="stylesheet" type="text/css" href="{{themeAssets('app-assets/vendors/css/vendors.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{themeAssets('app-assets/vendors/css/editors/quill/katex.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{themeAssets('app-assets/vendors/css/editors/quill/monokai-sublime.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{themeAssets('app-assets/vendors/css/editors/quill/quill.snow.css')}}">
    <link rel="stylesheet" type="text/css" href="{{themeAssets('app-assets/vendors/css/extensions/toastr.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{themeAssets('app-assets/vendors/css/forms/select/select2.min.css')}}">
@endsection
@section('scripts')
    <script src="{{themeAssets('app-assets/vendors/js/editors/quill/katex.min.js')}}"></script>
    <script src="{{themeAssets('app-assets/vendors/js/editors/quill/highlight.min.js')}}"></script>
    <script src="{{themeAssets('app-assets/vendors/js/editors/quill/quill.min.js')}}"></script>
    ...
    <script src="{{themeAssets('app-assets/js/scripts/pages/app-email.js')}}"></script>
    <script>
        tinymce.init({
