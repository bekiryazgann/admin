<?php $__env->startSection('title', 'E-posta Yönetimi'); ?>
<?php $__env->startSection('contentClass', 'email-application'); ?>
                        ...
                        <div class="sidebar-menu-list">
                            <div class="list-group list-group-messages">
                                <a href="#" class="list-group-item list-group-item-action active">
                                    ...
                                    <span class="align-middle"> <?php echo trans("Gelen Kutusu") ?> </span>
                            ...
                            <div class="d-flex align-content-center justify-content-between w-100">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text"
                                           class="form-control"
                                           id="email-search"
                                           placeholder="<?php echo trans("Postalarda arayın") ?>"
                                           aria-label="<?php echo trans("Postalarda arayın") ?>"
                        ...
                        <div class="app-action">
                            <div class="action-left">
                                <div class="form-check selectAll">
                                    ...
                                    <label class="form-check-label fw-bolder ps-25" for="selectAllCheck">
                                        Tümünü Seç
                                    </label>
                                </div>
                            </div>
                            <div class="action-right">
                                <ul class="list-inline m-0">
                                    <li class="list-inline-item">
                                        <div class="dropdown">
                                            <a href="#" class="dropdown-toggle" id="folder" data-bs-toggle="dropdown"
                                    ...
                                    <li class="list-inline-item">
                                        <div class="dropdown">
                                            <a href="#" class="dropdown-toggle" id="tag" data-bs-toggle="dropdown"
                                               aria-haspopup="true" aria-expanded="false">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="tag">
                                                ...
                                                <a href="#" class="dropdown-item">
                                                    <span class="me-50 bullet bullet-primary bullet-sm"></span>
                                                    Company
                                                </a>
                            ...
                            <ul class="email-media-list">
                                <li class="d-flex user-mail mail-read">
                                    <div class="mail-left pe-50">
                                        <div class="avatar">
                                            <img src="<?php echo e(themeAssets('app-assets/images/portrait/small/avatar-s-20.jpg')); ?>"
                                ...
                                <li class="d-flex user-mail">
                                    <div class="mail-left pe-50">
                                        <div class="avatar">
                                            <img src="<?php echo e(themeAssets('app-assets/images/portrait/small/avatar-s-17.jpg')); ?>"
                                ...
                                <li class="d-flex user-mail mail-read">
                                    <div class="mail-left pe-50">
                                        <div class="avatar">
                                            <img src="<?php echo e(themeAssets('app-assets/images/portrait/small/avatar-s-7.jpg')); ?>"
                                                 alt="Generic placeholder image"/>
                                        </div>
                                        <div class="user-action">
                                            <div class="form-check">
                                ...
                                <li class="d-flex user-mail mail-read">
                                    <div class="mail-left pe-50">
                                        <div class="avatar">
                                            <img src="<?php echo e(themeAssets('app-assets/images/portrait/small/avatar-s-5.jpg')); ?>"
                                                 alt="Generic placeholder image"/>
                                        </div>
                                        <div class="user-action">
                                            <div class="form-check">
                                ...
                                <li class="d-flex user-mail">
                                    <div class="mail-left pe-50">
                                        <div class="avatar">
                                            <img src="<?php echo e(themeAssets('app-assets/images/portrait/small/avatar-s-3.jpg')); ?>"
                                                 alt="Generic placeholder image"/>
                                        </div>
                                        <div class="user-action">
                                            <div class="form-check">
                                ...
                                <li class="d-flex user-mail">
                                    <div class="mail-left pe-50">
                                        <div class="avatar">
                                            <img src="<?php echo e(themeAssets('app-assets/images/portrait/small/avatar-s-8.jpg')); ?>"
                                                 alt="Generic placeholder image"/>
                                        </div>
                                        <div class="user-action">
                                            <div class="form-check">
                                ...
                                <li class="d-flex user-mail mail-read">
                                    <div class="mail-left pe-50">
                                        <div class="avatar">
                                            <img src="<?php echo e(themeAssets('app-assets/images/portrait/small/avatar-s-11.jpg')); ?>"
                                                 alt="Generic placeholder image"/>
                                        </div>
                                        <div class="user-action">
                                            <div class="form-check">
                                ...
                                <li class="d-flex user-mail mail-read">
                                    <div class="mail-left pe-50">
                                        <div class="avatar">
                                            <img src="<?php echo e(themeAssets('app-assets/images/portrait/small/avatar-s-10.jpg')); ?>"
                                                 alt="Generic placeholder image"/>
                                        </div>
                                        <div class="user-action">
                                            <div class="form-check">
                                ...
                                <li class="d-flex user-mail mail-read">
                                    <div class="mail-left pe-50">
                                        <div class="avatar">
                                            <img src="<?php echo e(themeAssets('app-assets/images/portrait/small/avatar-s-6.jpg')); ?>"
                                                 alt="Generic placeholder image"/>
                                        </div>
                                        <div class="user-action">
                                            <div class="form-check">
                                ...
                                <li class="d-flex user-mail">
                                    <div class="mail-left pe-50">
                                        <div class="avatar">
                                            <img src="<?php echo e(themeAssets('app-assets/images/portrait/small/avatar-s-9.jpg')); ?>"
                                                 alt="Generic placeholder image"/>
                                        </div>
                                        <div class="user-action">
                                            <div class="form-check">
                                            ...
                                            <div class="mail-meta-item d-flex align-items-center">
                                                ...
                                                <div class="dropdown ms-50">
                                                    <div role="button" class="dropdown-toggle hide-arrow"
                                                         id="email_more" data-bs-toggle="dropdown" aria-haspopup="true"
                                                         aria-expanded="false">
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header email-detail-head">
                                            <div class="user-details d-flex justify-content-between align-items-center flex-wrap">
                                                <div class="avatar me-75">
                                                    <img src="<?php echo e(themeAssets('app-assets/images/portrait/small/avatar-s-18.jpg')); ?>"
                                                         alt="avatar img holder" width="48" height="48"/>
                                                </div>
                                                <div class="mail-items">
                                        ...
                                        <div class="card-footer">
                                            <div class="mail-attachments">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <a href="#" class="mb-50">
                                                        <img src="<?php echo e(themeAssets('app-assets/images/icons/doc.png')); ?>"
                                                             class="me-25" alt="png" height="18"/>
                                                        <small class="text-muted fw-bolder">interdum.docx</small>
                                                    </a>
                                                    <a href="#">
                                                        <img src="<?php echo e(themeAssets('app-assets/images/icons/jpg.png')); ?>"
                                                             class="me-25" alt="png" height="18"/>
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-scrollable">
                            <div class="modal-content p-0">
                                <div class="modal-header">
                                    <h5 class="modal-title"> Yeni Posta </h5>
                                ...
                                <div class="modal-body flex-grow-1 p-0">
                                    <form class="compose-form">
                                        <div class="compose-mail-form-field">
                                            <label for="email-too" class="form-label">Kime: </label>
                                            <div class="flex-grow-1">
                                                <input type="text"
                                                       class="form-control w-100"
                                                       id="email-too"
                                                       placeholder="Ör, socore@socore.app">
                                            </div>
                                        </div>
                                        <div class="compose-mail-form-field">
                                            ...
                                            <input type="text" id="emailSubject"
                                                   class="form-control"
                                                   placeholder="Ör, Yeni Ürünlerimizle Tanışın - %20 İndirim Fırsatı"
                                                   name="emailSubject"/>
                                        </div>
                                        <textarea id="email-editor" placeholder="Mesaj"></textarea>
...
<?php $__env->startSection('styles'); ?>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(themeAssets('app-assets/css/plugins/forms/form-quill-editor.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(themeAssets('app-assets/css/plugins/extensions/ext-component-toastr.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(themeAssets('app-assets/css/pages/app-email.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(themeAssets('app-assets/vendors/css/vendors.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(themeAssets('app-assets/vendors/css/editors/quill/katex.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(themeAssets('app-assets/vendors/css/editors/quill/monokai-sublime.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(themeAssets('app-assets/vendors/css/editors/quill/quill.snow.css')); ?>">
...
<?php $__env->startSection('scripts'); ?>
    <script src="<?php echo e(themeAssets('app-assets/vendors/js/editors/quill/katex.min.js')); ?>"></script>
    <script src="<?php echo e(themeAssets('app-assets/vendors/js/editors/quill/highlight.min.js')); ?>"></script>
    <script src="<?php echo e(themeAssets('app-assets/vendors/js/editors/quill/quill.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(themeAssets('app-assets/js/scripts/pages/app-email.js')); ?>"></script>
    <script>
        tinymce.init({
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bekir/Desktop/admin/themes/admin/views/apps/mail/main.blade.php ENDPATH**/ ?>