<footer class="border-t border-t-blue-500 border-t-8">
            ...
            @foreach($data['menu'] as $menu1)
                <ul>
                    <li class="lg:mb-2 mb-1">
                        <a href="" class="lg:text-2xl text-xl font-bold text-gray-900"> {{$menu1['title']}} </a>
                    </li>
                    @foreach($menu1['menu'] as $menu2)
                        <li>
                            <a href="{{$menu2['url']}}" class="text-gray-500 text-sm">{{$menu2['title']}}</a>
                        </li>
                    @endforeach
                </ul>
            @endforeach
    ...
    <div class="bg-blue-500">
        <div class="mx-auto lg:py-4 py-2 max-w-7xl px-2 flex items-center justify-between lg:flex-row flex-col">
            <img class="" src="{{$data['logo']}}" alt="" style="height: 40px">
