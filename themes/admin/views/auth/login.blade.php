...
<head>
    ...
    <title>@trans(Giriş Yap) - @trans(Socore Dijital Sistemler)</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{themeAssets('app-assets/css/themes/light-layout.css')}}">
    <link rel="stylesheet" type="text/css" href="{{themeAssets('app-assets/css/themes/bordered-layout.css')}}">
    <link rel="stylesheet" type="text/css" href="{{themeAssets('app-assets/css/themes/semi-light-layout.css')}}">
        ...
        <div class="content-body">
            <div class="auth-wrapper auth-cover">
                <div class="auth-inner row m-0">
                    <a class="brand-logo" href="{{siteUrl('auth/login')}}">
                        <svg version="1.1"
                             id="Layer_1"
                    ...
                    <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                        <div class="w-100 d-lg-flex align-items-center justify-content-center px-5">
                            <img class="img-fluid" src="{{themeAssets('app-assets/images/pages/login-v2.svg')}}"
                                 alt="Login V2"/>
                        </div>
                    </div>
                    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            <h2 class="card-title fw-bold mb-1">{{trans("Socore'a Hoşgeldin!")}}</h2>
                            <p class="card-text mb-2">@trans(Hesabına giriş yapabilirsin.)</p>
                            <form class="auth-login-form mt-2" method="POST" autocomplete="off">
                                @csrf
                                <div class="mb-1">
                                    <label class="form-label" for="login-email">@trans(E-posta)</label>
                                    <input class="form-control"
                                           id="login-email"
                                           type="text"
                                           name="email"
                                           placeholder="@trans(mertucar@example.com)"
                                ...
                                <div class="mb-1">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{siteUrl('auth/forgot-password')}}">
                                            <small>@trans(Parolamı Unuttum)</small>
                                        </a>
                                    </div>
                                ...
                                <div class="mb-1">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="remember-me"> @trans(Beni Hatırla) </label>
                                    </div>
                                </div>
                                <button class="btn btn-primary w-100" tabindex="4"> @trans(Giriş Yap) </button>
                            </form>
                            <p class="text-center mt-2">
                                <span>@trans(Yeni misin?)</span>
                                <a href="{{siteUrl('auth/register')}}">
                                    <span> @trans(Hesap Oluştur!) </span>
                                </a>
                            </p>
                        </div>
                    </div>
...
<script src="{{themeAssets('app-assets/js/scripts/pages/auth-login.js')}}"></script>
<script>
    @if(auth()->get('msg'))
        toastr['info']("{!! auth()->get('msg') !!}", "@trans(Bilgi)", {
        closeButton: true,
        tapToDismiss: false,
        rtl: false
    });
