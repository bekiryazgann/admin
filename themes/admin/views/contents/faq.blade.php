...
@section('title', trans('Sıkça Sorulan Sorular'))
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">@trans(Sıkça Sorulan Sorular)</h2>
        ...
        <div class="col-md-3 text-end">
            <button class="btn btn-primary"
                    id="newQuestion">@trans(Yeni Soru)</button>
        </div>
    </div>
    <div class="content-body">
        <section id="basic-datatable" class="table">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <table class="datatables-basic table" id="faq">
...
@section('scripts')
    ...
    <script src="{{themeAssets('assets/js/pages/faq.js')}}"></script>
@endsection