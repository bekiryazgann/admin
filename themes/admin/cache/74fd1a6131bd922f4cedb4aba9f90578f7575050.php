<?php
    $layout = \Illuminate\Database\Capsule\Manager::table('user')
        ...
        ->all()[0]->layout;
?><!DOCTYPE html>
<html class="loading <?php echo e($layout); ?>" lang="en" data-layout="<?php echo e($layout); ?>"
...
<?php endif; ?>
    ...
    <script src="<?php echo e(themeAssets('assets/js/media.js')); ?>"></script>
...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow"
    ...
    <?php echo $__env->make('layouts.headerNavbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
</html><?php /**PATH /Users/bekir/Desktop/admin/themes/admin/views/layouts/layout.blade.php ENDPATH**/ ?>