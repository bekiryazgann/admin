...
(function (window, document, $) {
    ...
    let assetPath = assetUrl + '/app-assets/';
    ...
    */
    ...
    searchInputInputfield.on('keyup', function (e) {
        ...
        if (e.keyCode !== 38 && e.keyCode !== 40 && e.keyCode !== 13) {
            ...
            if (value != '') {
                ...
                $.getJSON(url + 'api/dashboard-search', function (data) {
    ...
    let mode = new BroadcastChannel('mode');


    mode.addEventListener('message', e => {
        let currentLayout = getCurrentLayout(),
            switchToLayout = '',
            prevLayout = localStorage.getItem(dataLayout + '-prev-skin', currentLayout);
        localStorage.setItem(dataLayout + '-prev-skin', currentLayout);
        localStorage.setItem(dataLayout + '-current-skin', e.data);
    ...
    $('.nav-link-style').on('click', function () {
        ...
        if (currentLayout !== 'dark-layout') {
            ...
            mode.postMessage('dark-layout');
        } else {
            if (currentLayout === prevLayout) {
                switchToLayout = 'light-layout';
                mode.postMessage('light-layout');
            } else {
                switchToLayout = prevLayout ? prevLayout : 'light-layout';
                mode.postMessage(prevLayout ? prevLayout : 'light-layout');
            }
        }
...
!function () {
    ...
    n = (n = n.replace("http://", "")).replace("https://", ""), e.forEach(function(element, index) {
        var link = element.querySelector("a");
        if (link !== null && link.hasAttribute("href")) {
            var hrefValue = link.getAttribute("href");
            if (hrefValue.replace("//", "") === n) {
...
("function" == typeof define && define.amd ? define : function (e, t) {
    ...
    return b = 0, e = {
        clear: function (e, t) {
            var s = C();
            if (T || h(s), !a(e, s, t)) for (var o = s, n = T.children(), i = n.length - 1; 0 <= i; i--) a(f(n[i]), o)
        }, remove: function (e) {
            var t = C();
            return T || h(t), e && 0 === f(":focus", e).length ? void w(e) : void (T.children().length && T.remove())
        }, error: function (e, t, s) {
            return o({type: "error", iconClass: C().iconClasses.error, message: e, optionsOverride: s, title: t})
        }, getContainer: h, info: function (e, t, s) {
            return o({type: "info", iconClass: C().iconClasses.info, message: e, optionsOverride: s, title: t})
        }, options: {}, subscribe: function (e) {
            t = e
        }, success: function (e, t, s) {
            return o({type: "success", iconClass: C().iconClasses.success, message: e, optionsOverride: s, title: t})
        }, version: "2.1.3", warning: function (e, t, s) {
            return o({type: "warning", iconClass: C().iconClasses.warning, message: e, optionsOverride: s, title: t})
        }
    };

    function h(e, t) {
        return e = e || C(), (T = f("#" + e.containerId)).length || t && (t = e, (T = f("<div/>").attr("id", t.containerId).addClass("toast-container").addClass(t.positionClass)).appendTo(f(t.target))), T
    }

    function a(e, t, s) {
        return s = !(!s || !s.force) && s.force, e && (s || 0 === f(":focus", e).length) && (e[t.hideMethod]({
    ...
    function o(e) {
        ...
        function s(e) {
            var t = e && !1 !== u.closeMethod ? u.closeMethod : u.hideMethod,
                s = e && !1 !== u.closeDuration ? u.closeDuration : u.hideDuration,
                o = e && !1 !== u.closeEasing ? u.closeEasing : u.hideEasing;
            if (!f(":focus", i).length || e) return clearTimeout(d.intervalId), i[t]({
                duration: s,
                easing: o,
                complete: function () {
                    w(i), clearTimeout(n), u.onHidden && "hidden" !== c.state && u.onHidden(), c.state = "hidden", c.endTime = new Date, v(c)
                }
            })
        }

        var n, i, o, a, r, l, d, c, u = C(), p = e.iconClass || u.iconClass;
        if (void 0 !== e.optionsOverride && (u = f.extend(u, e.optionsOverride), p = e.optionsOverride.iconClass || p), !function () {
            if (u.preventDuplicates) {
                if (e.message === O) return 1;
                O = e.message
            }
        }()) {
            b++, T = h(u, !0), n = null, i = f("<div/>"), o = f("<div/>"), a = f("<div/>"), r = f("<div/>"), l = f(u.closeHtml), d = {
                intervalId: null,
                hideEta: null,
                maxHideTime: null
            }, c = {toastId: b, state: "visible", startTime: new Date, options: u, map: e};
            {
                e.iconClass && i.addClass(u.toastClass).addClass(p), e.title && (m = e.title, u.escapeHtml && (m = t(e.title)), o.append(m).addClass(u.titleClass), i.append(o)), e.message && (m = e.message, u.escapeHtml && (m = t(e.message)), a.append(m).addClass(u.messageClass), i.append(a)), u.closeButton && (l.addClass(u.closeClass).attr("role", "button"), i.prepend(l)), u.progressBar && (r.addClass(u.progressClass), i.prepend(r)), u.rtl && i.addClass("rtl"), u.newestOnTop ? T.prepend(i) : T.append(i);
                var m, g = "";
                switch (e.iconClass) {
                    case"toast-success":
                    case"toast-info":
            ...
            return i.hide(), i[u.showMethod]({
                duration: u.showDuration,
                easing: u.showEasing,
                complete: u.onShown
            }), 0 < u.timeOut && (n = setTimeout(s, u.timeOut), d.maxHideTime = parseFloat(u.timeOut), d.hideEta = (new Date).getTime() + d.maxHideTime, u.progressBar) && (d.intervalId = setInterval(function () {
                var e = (d.hideEta - (new Date).getTime()) / d.maxHideTime * 100;
                r.width(e + "%")
            }, 10)), u.closeOnHover && i.hover(function () {
                clearTimeout(n), d.hideEta = 0, i.stop(!0, !0)[u.showMethod]({
                    duration: u.showDuration,
                    easing: u.showEasing
                })
            }, function () {
                (0 < u.timeOut || 0 < u.extendedTimeOut) && (n = setTimeout(s, u.extendedTimeOut), d.maxHideTime = parseFloat(u.extendedTimeOut), d.hideEta = (new Date).getTime() + d.maxHideTime)
            }), !u.onclick && u.tapToDismiss && i.click(s), u.closeButton && l && l.click(function (e) {
                e.stopPropagation ? e.stopPropagation() : void 0 !== e.cancelBubble && !0 !== e.cancelBubble && (e.cancelBubble = !0), u.onCloseClick && u.onCloseClick(e), s(!0)
            }), u.onclick && i.click(function (e) {
                u.onclick(e), s()
            }), v(c), u.debug && console && console.log(c), i
        }
    }
    ...
    function w(e) {
        T = T || h(), e.is(":visible") || (e.remove(), e = null, 0 === T.children().length && (T.remove(), O = void 0))
    }
...
$(function () {
    "use strict";
    var o = $("#section-block"), e = $(".btn-section-block"), t = $(".btn-section-block-overlay"),
        s = $(".btn-section-block-spinner"), r = $(".btn-section-block-custom"), n = $(".btn-section-block-multiple"),
        c = $("#card-block"), l = $(".btn-card-block"), a = $(".btn-card-block-overlay"),
        i = $(".btn-card-block-spinner"), b = $(".btn-card-block-custom"), d = $(".btn-card-block-multiple"),
        g = $(".btn-page-block"), u = $(".btn-page-block-overlay"), p = $(".btn-page-block-spinner"),
        f = $(".btn-page-block-custom"), m = $(".btn-page-block-multiple"), k = $(".form-block"),
        v = $(".btn-form-block"), y = $(".btn-form-block-overlay"), C = $(".btn-form-block-spinner"),
        S = $(".btn-form-block-custom"), h = $(".btn-form-block-multiple");
    e.length && o.length && e.on("click", function () {
        o.block({
    ...
    }), t.length && o.length && t.on("click", function () {
        o.block({
    ...
    }), s.length && o.length && s.on("click", function () {
        o.block({
    ...
    }), r.length && o.length && r.on("click", function () {
        o.block({
    ...
    }), n.length && o.length && n.on("click", function () {
        o.block({
            message: '<div class="d-flex justify-content-center align-items-center"><p class="me-50 mb-0">Please wait...</p> <div class="spinner-grow spinner-grow-sm text-white" role="status"></div>',
            css: {backgroundColor: "transparent", color: "#fff", border: "0"},
            overlayCSS: {opacity: .5},
    ...
    }), l.length && c.length && l.on("click", function () {
        c.block({
            message: '<div class="spinner-border text-white" role="status"></div>',
            timeout: 1e3,
            css: {backgroundColor: "transparent", border: "0"},
    ...
    }), a.length && c.length && a.on("click", function () {
        c.block({
            message: '<div class="spinner-border text-primary" role="status"></div>',
            timeout: 1e3,
            css: {backgroundColor: "transparent", border: "0"},
    ...
    }), i.length && c.length && i.on("click", function () {
        c.block({
            message: '<div class="spinner-grow spinner-grow-sm text-white" role="status"></div>',
            timeout: 1e3,
            css: {backgroundColor: "transparent", color: "#fff", border: "0"},
    ...
    }), b.length && c.length && b.on("click", function () {
        c.block({
    ...
    }), d.length && c.length && d.on("click", function () {
        c.block({
            message: '<div class="d-flex justify-content-center align-items-center"><p class="me-50 mb-0">Please wait...</p> <div class="spinner-grow spinner-grow-sm text-white" role="status"></div> </div>',
            css: {backgroundColor: "transparent", color: "#fff", border: "0"},
            overlayCSS: {opacity: .5},
    ...
    }), v.length && k.length && v.on("click", function () {
        k.block({
            message: '<div class="spinner-border text-white" role="status"></div>',
            timeout: 1e3,
            css: {backgroundColor: "transparent", color: "#fff", border: "0"},
    ...
    }), y.length && k.length && y.on("click", function () {
        k.block({
            message: '<div class="spinner-border text-primary" role="status"></div>',
            timeout: 1e3,
            css: {backgroundColor: "transparent", border: "0"},
    ...
    }), C.length && k.length && C.on("click", function () {
        k.block({
            message: '<div class="spinner-grow spinner-grow-sm text-white" role="status"></div>',
            timeout: 1e3,
            css: {backgroundColor: "transparent", color: "#fff", border: "0"},
    ...
    }), S.length && k.length && S.on("click", function () {
        k.block({
            message: '<div class="d-flex justify-content-center align-items-center"><p class="me-50 mb-0">Please wait...</p> <div class="spinner-grow spinner-grow-sm text-white" role="status"></div> </div>',
            timeout: 1e3,
            css: {backgroundColor: "transparent", color: "#fff", border: "0"},
    ...
    }), h.length && k.length && h.on("click", function () {
        k.block({
            message: '<div class="d-flex justify-content-center align-items-center"><p class="me-50 mb-0">Please wait...</p> <div class="spinner-grow spinner-grow-sm text-white" role="status"></div> </div>',
            css: {backgroundColor: "transparent", color: "#fff", border: "0"},
            overlayCSS: {opacity: .5},
...
!function (e, t) {
    ...
    const E = Object.freeze({cancel: "cancel", backdrop: "backdrop", close: "close", esc: "esc", timer: "timer"}),
        s = "SweetAlert2:", K = e => e.charAt(0).toUpperCase() + e.slice(1), k = e => Array.prototype.slice.call(e),
        x = e => {
            console.warn("".concat(s, " ").concat("object" == typeof e ? e.join(" ") : e))
        }, P = e => {
            console.error("".concat(s, " ").concat(e))
        }, X = [], J = e => "function" == typeof e ? e() : e, G = e => e && "function" == typeof e.toPromise,
        S = e => G(e) ? e.toPromise() : Promise.resolve(e), Q = e => e && Promise.resolve(e) === e,
        n = e => e instanceof Element || "object" == typeof e && e.jquery;
    var e = e => {
        var t = {};
        for (const o in e) t[e[o]] = "swal2-" + e[o];
        return t
    };
    const T = e(["container", "shown", "height-auto", "iosfix", "popup", "modal", "no-backdrop", "no-transition", "toast", "toast-shown", "show", "hide", "close", "title", "html-container", "actions", "confirm", "deny", "cancel", "default-outline", "footer", "icon", "icon-content", "image", "input", "file", "range", "select", "radio", "checkbox", "label", "textarea", "inputerror", "input-label", "validation-message", "progress-steps", "active-progress-step", "progress-step", "progress-step-line", "loader", "loading", "styled", "top", "top-start", "top-end", "top-left", "top-right", "center", "center-start", "center-end", "center-left", "center-right", "bottom", "bottom-start", "bottom-end", "bottom-left", "bottom-right", "grow-row", "grow-column", "grow-fullscreen", "rtl", "timer-progress-bar", "timer-progress-bar-container", "scrollbar-measure", "icon-success", "icon-warning", "icon-info", "icon-question", "icon-error"]),
        h = e(["success", "warning", "info", "question", "error"]),
        L = () => document.body.querySelector(".".concat(T.container)), t = e => {
            var t = L();
            return t ? t.querySelector(e) : null
        }, o = e => t(".".concat(e)), O = () => o(T.popup), f = () => o(T.icon), v = () => o(T.title),
        C = () => o(T["html-container"]), A = () => o(T.image), ee = () => o(T["progress-steps"]),
        te = () => o(T["validation-message"]), j = () => t(".".concat(T.actions, " .").concat(T.confirm)),
        z = () => t(".".concat(T.actions, " .").concat(T.deny)), M = () => t(".".concat(T.loader)),
        D = () => t(".".concat(T.actions, " .").concat(T.cancel)), oe = () => o(T.actions), B = () => o(T.footer),
        ae = () => o(T["timer-progress-bar"]), se = () => o(T.close), ne = () => {
            var e = k(O().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort((e, t) => (e = parseInt(e.getAttribute("tabindex")), (t = parseInt(t.getAttribute("tabindex"))) < e ? 1 : e < t ? -1 : 0)),
                t = k(O().querySelectorAll('\n  a[href],\n  area[href],\n  input:not([disabled]),\n  select:not([disabled]),\n  textarea:not([disabled]),\n  button:not([disabled]),\n  iframe,\n  object,\n  embed,\n  [tabindex="0"],\n  [contenteditable],\n  audio[controls],\n  video[controls],\n  summary\n')).filter(e => "-1" !== e.getAttribute("tabindex"));
            return (t => {
                var o = [];
                for (let e = 0; e < t.length; e++) -1 === o.indexOf(t[e]) && o.push(t[e]);
                return o
            })(e.concat(t)).filter(e => F(e))
        }, u = () => !c() && !document.body.classList.contains(T["no-backdrop"]),
        c = () => document.body.classList.contains(T["toast-shown"]), d = {previousBodyPadding: null}, H = (t, e) => {
            t.textContent = "", e && (e = (new DOMParser).parseFromString(e, "text/html"), k(e.querySelector("head").childNodes).forEach(e => {
                t.appendChild(e)
            }), k(e.querySelector("body").childNodes).forEach(e => {
                t.appendChild(e)
            }))
        }, p = (t, e) => {
            if (!e) return !1;
            ...
            var a = e, s = t;
            if (k(a.classList).forEach(e => {
                Object.values(T).includes(e) || Object.values(h).includes(e) || Object.values(s.showClass).includes(e) || a.classList.remove(e)
            }), t.customClass && t.customClass[o]) {
                if ("string" != typeof t.customClass[o] && !t.customClass[o].forEach) return x("Invalid type of customClass.".concat(o, '! Expected string or iterable object, got "').concat(typeof t.customClass[o], '"'));
                I(e, t.customClass[o])
            }
        }, ie = (e, t) => {
            if (!t) return null;
            ...
            for (let e = 0; e < t.childNodes.length; e++) if (p(t.childNodes[e], o)) return t.childNodes[e]
        }, le = (e, t, o) => {
            (o = o === "".concat(parseInt(o)) ? parseInt(o) : o) || 0 === parseInt(o) ? e.style[t] = "number" == typeof o ? "".concat(o, "px") : o : e.style.removeProperty(t)
        }, N = (e, t = "flex") => {
            e.style.display = t
        }, U = e => {
            e.style.display = "none"
        }, l = (e, t, o, a) => {
            (e = e.querySelector(t)) && (e.style[o] = a)
        }, ce = (e, t, o) => {
            t ? N(e, o) : U(e)
        }, F = e => !(!e || !(e.offsetWidth || e.offsetHeight || e.getClientRects().length)),
        m = e => !!(e.scrollHeight > e.clientHeight), w = e => {
            var t = window.getComputedStyle(e), o = parseFloat(t.getPropertyValue("animation-duration") || "0"),
                e = parseFloat(t.getPropertyValue("transition-duration") || "0");
            return 0 < o || 0 < e
        }, de = (e, t = !1) => {
            const o = ae();
            F(o) && (t && (o.style.transition = "none", o.style.width = "100%"), setTimeout(() => {
                o.style.transition = "width ".concat(e / 1e3, "s linear"), o.style.width = "0%"
            }, 10))
        }, ue = () => "undefined" == typeof window || "undefined" == typeof document,
        pe = '\n <div aria-labelledby="'.concat(T.title, '" aria-describedby="').concat(T["html-container"], '" class="').concat(T.popup, '" tabindex="-1">\n   <button type="button" class="').concat(T.close, '"></button>\n   <ul class="').concat(T["progress-steps"], '"></ul>\n   <div class="').concat(T.icon, '"></div>\n   <img class="').concat(T.image, '" />\n   <h2 class="').concat(T.title, '" id="').concat(T.title, '"></h2>\n   <div class="').concat(T["html-container"], '"></div>\n   <input class="').concat(T.input, '" />\n   <input type="file" class="').concat(T.file, '" />\n   <div class="').concat(T.range, '">\n     <input type="range" />\n     <output></output>\n   </div>\n   <select class="').concat(T.select, '"></select>\n   <div class="').concat(T.radio, '"></div>\n   <label for="').concat(T.checkbox, '" class="').concat(T.checkbox, '">\n     <input type="checkbox" />\n     <span class="').concat(T.label, '"></span>\n   </label>\n   <textarea class="').concat(T.textarea, '"></textarea>\n   <div class="').concat(T["validation-message"], '" id="').concat(T["validation-message"], '"></div>\n   <div class="').concat(T.actions, '">\n     <div class="').concat(T.loader, '"></div>\n     <button type="button" class="').concat(T.confirm, '"></button>\n     <button type="button" class="').concat(T.deny, '"></button>\n     <button type="button" class="').concat(T.cancel, '"></button>\n   </div>\n   <div class="').concat(T.footer, '"></div>\n   <div class="').concat(T["timer-progress-bar-container"], '">\n     <div class="').concat(T["timer-progress-bar"], '"></div>\n   </div>\n </div>\n').replace(/(^|\n)\s*/g, ""),
        R = () => {
            i.isVisible() && i.resetValidationMessage()
        }, me = (e, t) => {
            e instanceof HTMLElement ? t.appendChild(e) : "object" == typeof e ? g(e, t) : e && H(t, e)
        }, g = (e, t) => {
            if (e.jquery) {
                var o = t, a = e;
                if (o.textContent = "", 0 in a) for (let e = 0; e in a; e++) o.appendChild(a[e].cloneNode(!0)); else o.appendChild(a.cloneNode(!0))
            } else H(t, e.toString())
        }, we = (() => {
            if (!ue()) {
    ...
    function ge(e, t, o) {
        ce(e, o["show".concat(K(t), "Button")], "inline-block"), H(e, o["".concat(t, "ButtonText")]), e.setAttribute("aria-label", o["".concat(t, "ButtonAriaLabel")]), e.className = T[t], b(e, o, "".concat(t, "Button")), I(e, o["".concat(t, "ButtonClass")])
    }

    var Y = {promise: new WeakMap, innerParams: new WeakMap, domCache: new WeakMap};
    const he = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], fe = (e, t) => {
            e.placeholder && !t.inputPlaceholder || (e.placeholder = t.inputPlaceholder)
        }, be = (e, t, o) => {
            var a, s;
            o.inputLabel && (e.id = T.input, a = document.createElement("label"), s = T["input-label"], a.setAttribute("for", e.id), a.className = s, I(a, o.customClass.inputLabel), a.innerText = o.inputLabel, t.insertAdjacentElement("beforebegin", a))
        }, ye = e => (e = T[e] || T.input, V(O(), e)), y = {},
        ve = (y.text = y.email = y.password = y.number = y.tel = y.url = (e, t) => ("string" == typeof t.inputValue || "number" == typeof t.inputValue ? e.value = t.inputValue : Q(t.inputValue) || x('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(typeof t.inputValue, '"')), be(e, e, t), fe(e, t), e.type = t.input, e), y.file = (e, t) => (be(e, e, t), fe(e, t), e), y.range = (e, t) => {
            var o = e.querySelector("input"), a = e.querySelector("output");
            return o.value = t.inputValue, o.type = t.input, a.value = t.inputValue, be(o, e, t), e
        }, y.select = (e, t) => {
            var o;
            return e.textContent = "", t.inputPlaceholder && (o = document.createElement("option"), H(o, t.inputPlaceholder), o.value = "", o.disabled = !0, o.selected = !0, e.appendChild(o)), be(e, e, t), e
        }, y.radio = e => (e.textContent = "", e), y.checkbox = (e, t) => {
            (o = ie(O(), "checkbox")).value = 1, o.id = T.checkbox, o.checked = Boolean(t.inputValue);
            var o = e.querySelector("span");
            return H(o, t.inputPlaceholder), e
        }, y.textarea = (t, e) => {
            if (t.value = e.inputValue, fe(t, e), be(t, t, e), "MutationObserver" in window) {
                const o = parseInt(window.getComputedStyle(O()).width);
                new MutationObserver(() => {
                    var e = t.offsetWidth + (e = t, parseInt(window.getComputedStyle(e).marginLeft) + parseInt(window.getComputedStyle(e).marginRight));
                    e > o ? O().style.width = "".concat(e, "px") : O().style.width = null
                }).observe(t, {attributes: !0, attributeFilter: ["style"]})
            }
            return t
        }, (e, t) => {
            for (const o in h) t.icon !== o && q(e, h[o]);
            I(e, h[t.icon]), Ce(e, t), ke(), b(e, t, "icon")
        }), ke = () => {
            var e = O(), t = window.getComputedStyle(e).getPropertyValue("background-color"),
            ...
            if (t.iconColor) {
                ...
                for (const o of [".swal2-success-line-tip", ".swal2-success-line-long", ".swal2-x-mark-line-left", ".swal2-x-mark-line-right"]) l(e, o, "backgroundColor", t.iconColor);
                l(e, ".swal2-success-ring", "borderColor", t.iconColor)
            }
        }, Ae = e => '<div class="'.concat(T["icon-content"], '">').concat(e, "</div>"), Be = (e, t) => {
            p = t, d = L(), u = O(), p.toast ? (le(d, "width", p.width), u.style.width = "100%", u.insertBefore(M(), f())) : le(u, "width", p.width), le(u, "padding", p.padding), p.background && (u.style.background = p.background), U(te()), d = p, (p = u).className = "".concat(T.popup, " ").concat(F(p) ? d.showClass.popup : ""), d.toast ? (I([document.documentElement, document.body], T["toast-shown"]), I(p, T.toast)) : I(p, T.modal), b(p, d, "popup"), "string" == typeof d.customClass && I(p, d.customClass), d.icon && I(p, T["icon-".concat(d.icon)]), u = t, (p = L()) && (d = p, "string" == typeof (r = u.backdrop) ? d.style.background = r : r || I([document.documentElement, document.body], T["no-backdrop"]), d = p, (r = u.position) in T ? I(d, T[r]) : (x('The "position" parameter is not valid, defaulting to "center"'), I(d, T.center)), r = p, (d = u.grow) && "string" == typeof d && (d = "grow-".concat(d)) in T && I(r, T[d]), b(p, u, "container")), (a => {
                const s = ee();
                if (!a.progressSteps || 0 === a.progressSteps.length) return U(s);
                N(s), s.textContent = "", a.currentProgressStep >= a.progressSteps.length && x("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), a.progressSteps.forEach((e, t) => {
                    var o = e;
                    e = document.createElement("li"), I(e, T["progress-step"]), H(e, o), s.appendChild(e), t === a.currentProgressStep && I(e, T["active-progress-step"]), t !== a.progressSteps.length - 1 && (o = a, e = document.createElement("li"), I(e, T["progress-step-line"]), o.progressStepsDistance && (e.style.width = o.progressStepsDistance), t = e, s.appendChild(t))
                })
            })(t), r = e, d = t, p = Y.innerParams.get(r), r = f(), p && d.icon === p.icon ? (xe(r, d), ve(r, d)) : d.icon || d.iconHtml ? d.icon && -1 === Object.keys(h).indexOf(d.icon) ? (P('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(d.icon, '"')), U(r)) : (N(r), xe(r, d), ve(r, d), I(r, d.showClass.icon)) : U(r), u = t, p = A(), u.imageUrl ? (N(p, ""), p.setAttribute("src", u.imageUrl), p.setAttribute("alt", u.imageAlt), le(p, "width", u.imageWidth), le(p, "height", u.imageHeight), p.className = T.image, b(p, u, "image")) : U(p), d = t, u = v(), ce(u, d.title || d.titleText, "block"), d.title && me(d.title, u), d.titleText && (u.innerText = d.titleText), b(u, d, "title"), p = t, u = se(), H(u, p.closeButtonHtml), b(u, p, "closeButton"), ce(u, p.showCloseButton), u.setAttribute("aria-label", p.closeButtonAriaLabel);
            var o, a, s, n, i, r, l, c, d = e, u = t, p = C();
            b(p, u, "htmlContainer"), u.html ? (me(u.html, p), N(p, "block")) : u.text ? (p.textContent = u.text, N(p, "block")) : U(p);
            {
                var p = d, m = u;
                const w = O(), g = !(p = Y.innerParams.get(p)) || m.input !== p.input;
                he.forEach(e => {
                    var t = T[e], o = V(w, t), a = m.inputAttributes, s = ie(O(), e);
                    if (s) {
                        var n = s;
                        for (let e = 0; e < n.attributes.length; e++) {
                            var i = n.attributes[e].name;
                            ["type", "value", "style"].includes(i) || n.removeAttribute(i)
                        }
                        for (const r in a) s.setAttribute(r, a[r])
                    }
                    o.className = t, g && U(o)
                }), m.input && (g && (e => {
                    if (!y[e.input]) return P('Unexpected type of input! Expected "text", "email", "password", "number", "tel", "select", "radio", "checkbox", "textarea", "file" or "url", got "'.concat(e.input, '"'));
                    var t = ye(e.input);
                    const o = y[e.input](t, e);
                    N(o), setTimeout(() => {
                        re(o)
                    })
                })(m), l = m, c = ye(l.input), l.customClass) && I(c, l.customClass.input)
            }
            d = t, u = oe(), p = M(), c = j(), l = z(), i = D(), d.showConfirmButton || d.showDenyButton || d.showCancelButton || U(u), b(u, d, "actions"), ge(c, "confirm", d), ge(l, "deny", d), ge(i, "cancel", d), o = c, a = l, s = i, (n = d).buttonsStyling ? (I([o, a, s], T.styled), n.confirmButtonColor && (o.style.backgroundColor = n.confirmButtonColor, I(o, T["default-outline"])), n.denyButtonColor && (a.style.backgroundColor = n.denyButtonColor, I(a, T["default-outline"])), n.cancelButtonColor && (s.style.backgroundColor = n.cancelButtonColor, I(s, T["default-outline"]))) : q([o, a, s], T.styled), d.reverseButtons && (u.insertBefore(i, p), u.insertBefore(l, p), u.insertBefore(c, p)), H(p, d.loaderHtml), b(p, d, "loader"), r = t, e = B(), ce(e, r.footer), r.footer && me(r.footer, e), b(e, r, "footer"), "function" == typeof t.didRender && t.didRender(O())
        }, Ee = () => j() && j().click(), Z = e => {
            var t, o, a, s = O(), n = (s || i.fire(), s = O(), M());
            c() ? U(f()) : (t = s, o = oe(), a = M(), !e && F(j()) && (e = j()), N(o), e && (U(e), a.setAttribute("data-button-to-replace", e.className)), a.parentNode.insertBefore(a, e), I([t, o], T.loading)), N(n), s.setAttribute("data-loading", !0), s.setAttribute("aria-busy", !0), s.focus()
        }, $ = {}, Pe = a => new Promise(e => {
            if (!a) return e();
            var t = window.scrollX, o = window.scrollY;
            $.restoreFocusTimeout = setTimeout(() => {
                $.previousActiveElement && $.previousActiveElement.focus ? ($.previousActiveElement.focus(), $.previousActiveElement = null) : document.body && document.body.focus(), e()
            }, 100), window.scrollTo(t, o)
        }), Se = () => {
            if ($.timeout) return e = ae(), t = parseInt(window.getComputedStyle(e).width), e.style.removeProperty("transition"), e.style.width = "100%", o = parseInt(window.getComputedStyle(e).width), o = parseInt(t / o * 100), e.style.removeProperty("transition"), e.style.width = "".concat(o, "%"), $.timeout.stop();
            var e, t, o
        }, Te = () => {
            var e;
            if ($.timeout) return e = $.timeout.start(), de(e), e
        };
    let Le = !1;
    const Oe = {}, je = t => {
            for (let e = t.target; e && e !== document; e = e.parentNode) for (const a in Oe) {
                var o = e.getAttribute(a);
                if (o) return void Oe[a].fire({template: o})
            }
        }, W = {
            title: "",
            titleText: "",
        ...
        He = e => Object.prototype.hasOwnProperty.call(W, e), Ie = e => Me[e];
    var qe = Object.freeze({
        ...
        argsToParams: o => {
            const a = {};
            return "object" != typeof o[0] || n(o[0]) ? ["title", "html", "icon"].forEach((e, t) => {
                "string" == typeof (t = o[t]) || n(t) ? a[e] = t : void 0 !== t && P("Unexpected type of ".concat(e, '! Expected "string" or "Element", got ').concat(typeof t))
            }) : Object.assign(a, o[0]), a
        },
        isVisible: () => F(O()),
        clickConfirm: Ee,
        clickDeny: () => z() && z().click(),
        ...
        toggleTimer: () => {
            var e = $.timeout;
            return e && (e.running ? Se : Te)()
        },
        increaseTimer: e => {
            if ($.timeout) return e = $.timeout.increase(e), de(e, !0), e
        },
        isTimerRunning: () => $.timeout && $.timeout.isRunning(),
        bindClickHandler: function (e = "data-swal-template") {
            Oe[e] = this, Le || (document.body.addEventListener("click", je), Le = !0)
        }
    });

    function Ve() {
        var e, t, o = Y.innerParams.get(this);
        o && (e = Y.domCache.get(this), U(e.loader), c() ? o.icon && N(f()) : (t = (o = e).popup.getElementsByClassName(o.loader.getAttribute("data-button-to-replace"))).length ? N(t[0], "inline-block") : F(j()) || F(z()) || F(D()) || U(o.actions), q([e.popup, e.actions], T.loading), e.popup.removeAttribute("aria-busy"), e.popup.removeAttribute("data-loading"), e.confirmButton.disabled = !1, e.denyButton.disabled = !1, e.cancelButton.disabled = !1)
    }

    const Ne = e => e.touches && e.touches.length && "stylus" === e.touches[0].touchType,
        Ue = e => e.touches && 1 < e.touches.length;
    var Fe = {swalPromiseResolve: new WeakMap};

    function Re(e, t, o, a) {
        c() ? Ze(e, a) : (Pe(o).then(() => Ze(e, a)), $.keydownTarget.removeEventListener("keydown", $.keydownHandler, {capture: $.keydownListenerCapture}), $.keydownHandlerAdded = !1), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) ? (t.setAttribute("style", "display:none !important"), t.removeAttribute("class"), t.innerHTML = "") : t.remove(), u() && (null !== d.previousBodyPadding && (document.body.style.paddingRight = "".concat(d.previousBodyPadding, "px"), d.previousBodyPadding = null), p(document.body, T.iosfix) && (t = parseInt(document.body.style.top, 10), q(document.body, T.iosfix), document.body.style.top = "", document.body.scrollTop = -1 * t), k(document.body.children).forEach(e => {
            e.hasAttribute("data-previous-aria-hidden") ? (e.setAttribute("aria-hidden", e.getAttribute("data-previous-aria-hidden")), e.removeAttribute("data-previous-aria-hidden")) : e.removeAttribute("aria-hidden")
        })), q([document.documentElement, document.body], [T.shown, T["height-auto"], T["no-backdrop"], T["toast-shown"]])
    }

    function Ye(e) {
        var t, o, a, s, n, i, r, l, c = O();
        c && (e = void 0 !== (o = e) ? Object.assign({
            isConfirmed: !1,
            isDenied: !1,
            isDismissed: !1
        }, o) : {
            ...
            isDenied: !1,
            isDismissed: !0
        }, a = Y.innerParams.get(this)) && !p(c, a.hideClass.popup) && (t = Fe.swalPromiseResolve.get(this), q(c, a.showClass.popup), I(c, a.hideClass.popup), o = L(), q(o, a.showClass.backdrop), I(o, a.hideClass.backdrop), o = this, r = L(), l = we && w(c), "function" == typeof a.willClose && a.willClose(c), l ? (l = o, s = c, c = r, n = a.returnFocus, i = a.didClose, $.swalCloseEventFinishedCallback = Re.bind(null, l, c, n, i), s.addEventListener(we, function (e) {
            e.target === s && ($.swalCloseEventFinishedCallback(), delete $.swalCloseEventFinishedCallback)
        })) : Re(o, r, a.returnFocus, a.didClose), t(e))
    }
    ...
    const Xe = ["swal-title", "swal-html", "swal-footer"], _ = (t, o) => {
        k(t.attributes).forEach(e => {
            -1 === o.indexOf(e.name) && x(['Unrecognized attribute "'.concat(e.name, '" on <').concat(t.tagName.toLowerCase(), ">."), "".concat(o.length ? "Allowed attributes are: ".concat(o.join(", ")) : "To set the value, use HTML within the element.")])
        })
    }, Je = e => {
        const o = L(), a = O();
        "function" == typeof e.willOpen && e.willOpen(a);
        var t, s = window.getComputedStyle(document.body).overflowY, n = o, i = a, r = e;
        if (I(n, r.showClass.backdrop), i.style.setProperty("opacity", "0", "important"), N(i, "grid"), setTimeout(() => {
            I(i, r.showClass.popup), i.style.removeProperty("opacity")
        }, 10), I([document.documentElement, document.body], T.shown), r.heightAuto && r.backdrop && !r.toast && I([document.documentElement, document.body], T["height-auto"]), setTimeout(() => {
            var e = o, t = a;
            we && w(t) ? (e.style.overflowY = "hidden", t.addEventListener(we, Ge)) : e.style.overflowY = "auto"
        }, 10), u()) {
            if (t = o, n = e.scrollbarPadding, (/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream || "MacIntel" === navigator.platform && 1 < navigator.maxTouchPoints) && !p(document.body, T.iosfix)) {
                l = document.body.scrollTop, document.body.style.top = "".concat(-1 * l, "px"), I(document.body, T.iosfix);
                {
                    var l = L();
                    let a;
                    l.ontouchstart = e => {
                        var t, o;
                        a = (t = e.target, o = L(), !(Ne(e) || Ue(e) || t !== o && (m(o) || "INPUT" === t.tagName || "TEXTAREA" === t.tagName || m(C()) && C().contains(t))))
                    }, l.ontouchmove = e => {
                        a && (e.preventDefault(), e.stopPropagation())
                    }
                }
                navigator.userAgent.match(/(CriOS|FxiOS|EdgiOS|YaBrowser|UCBrowser)/i) || O().scrollHeight > window.innerHeight - 44 && (L().style.paddingBottom = "".concat(44, "px"))
            }
            n && "hidden" !== s && null === d.previousBodyPadding && document.body.scrollHeight > window.innerHeight && (d.previousBodyPadding = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right")), document.body.style.paddingRight = "".concat(d.previousBodyPadding + ((l = document.createElement("div")).className = T["scrollbar-measure"], document.body.appendChild(l), n = l.getBoundingClientRect().width - l.clientWidth, document.body.removeChild(l), n), "px")), setTimeout(() => {
                t.scrollTop = 0
            }), k(document.body.children).forEach(e => {
        ...
        c() || $.previousActiveElement || ($.previousActiveElement = document.activeElement), "function" == typeof e.didOpen && setTimeout(() => e.didOpen(a)), q(o, T["no-transition"])
    }, Ge = e => {
        var t = O();
        e.target === t && (e = L(), t.removeEventListener(we, Ge), e.style.overflowY = "auto")
    }, Qe = {
        select: (e, t, s) => {
            const a = V(e, T.select), n = (e, t, o) => {
                var a = document.createElement("option");
                a.value = o, H(a, t), a.selected = tt(o, s.inputValue), e.appendChild(a)
            };
            t.forEach(e => {
                var t = e[0], e = e[1];
                if (Array.isArray(e)) {
                    const o = document.createElement("optgroup");
                    o.label = t, o.disabled = !1, a.appendChild(o), e.forEach(e => n(o, e[1], e[0]))
                } else n(a, e, t)
            }), a.focus()
        }, radio: (e, t, s) => {
            const n = V(e, T.radio);
            t.forEach(e => {
                var t = e[0], e = e[1], o = document.createElement("input"), a = document.createElement("label"),
                    t = (o.type = "radio", o.name = T.radio, o.value = t, tt(t, s.inputValue) && (o.checked = !0), document.createElement("span"));
                H(t, e), t.className = T.label, a.appendChild(o), a.appendChild(t), n.appendChild(a)
            }), (e = n.querySelectorAll("input")).length && e[0].focus()
        }
    }, et = o => {
        const a = [];
        return "undefined" != typeof Map && o instanceof Map ? o.forEach((e, t) => {
            let o = e;
    ...
    }, tt = (e, t) => t && t.toString() === e.toString(), ot = (a, e, t) => {
        var o, s, n, i, r = (e => {
            var t, o = a.getInput();
            if (!o) return null;
            switch (e.input) {
                ...
                case"radio":
                    return (t = o).checked ? t.value : null;
                case"file":
                    return (t = o).files.length ? null !== t.getAttribute("multiple") ? t.files : t.files[0] : null;
                default:
                    return e.inputAutoTrim ? o.value.trim() : o.value
            }
        })(e);
        e.inputValidator ? (s = e, n = r, i = t, (o = a).disableInput(), Promise.resolve().then(() => S(s.inputValidator(n, s.validationMessage))).then(e => {
            o.enableButtons(), o.enableInput(), e ? o.showValidationMessage(e) : ("deny" === i ? at : nt)(o, s, n)
        })) : a.getInput().checkValidity() ? ("deny" === t ? at : nt)(a, e, r) : (a.enableButtons(), a.showValidationMessage(e.validationMessage))
    }, at = (t, e, o) => {
        e.showLoaderOnDeny && Z(z()), e.preDeny ? Promise.resolve().then(() => S(e.preDeny(o, e.validationMessage))).then(e => {
            !1 === e ? t.hideLoading() : t.closePopup({isDenied: !0, value: void 0 === e ? o : e})
        }) : t.closePopup({isDenied: !0, value: o})
    }, st = (e, t) => {
        e.closePopup({isConfirmed: !0, value: t})
    }, nt = (t, e, o) => {
        e.showLoaderOnConfirm && Z(), e.preConfirm ? (t.resetValidationMessage(), Promise.resolve().then(() => S(e.preConfirm(o, e.validationMessage))).then(e => {
            F(te()) || !1 === e ? t.hideLoading() : st(t, void 0 === e ? o : e)
        })) : st(t, o)
    }, it = (e, t, o) => {
        var a = ne();
        if (a.length) return (t += o) === a.length ? t = 0 : -1 === t && (t = a.length - 1), a[t].focus();
        O().focus()
    }, rt = ["ArrowRight", "ArrowDown"], lt = ["ArrowLeft", "ArrowUp"];
    let ct = !1;
    const dt = e => {
        for (const t in e) e[t] = new WeakMap
    };
    e = Object.freeze({
        hideLoading: Ve, disableLoading: Ve, getInput: function (e) {
            var t = Y.innerParams.get(e || this);
            return (e = Y.domCache.get(e || this)) ? ie(e.popup, t.input) : null
        }, close: Ye, closePopup: Ye, closeModal: Ye, closeToast: Ye, enableButtons: function () {
            $e(this, ["confirmButton", "denyButton", "cancelButton"], !1)
        }, disableButtons: function () {
            $e(this, ["confirmButton", "denyButton", "cancelButton"], !0)
        }, enableInput: function () {
            return We(this.getInput(), !1)
        }, disableInput: function () {
            return We(this.getInput(), !0)
        }, showValidationMessage: function (e) {
            var t = Y.domCache.get(this), o = Y.innerParams.get(this);
            H(t.validationMessage, e), t.validationMessage.className = T["validation-message"], o.customClass && o.customClass.validationMessage && I(t.validationMessage, o.customClass.validationMessage), N(t.validationMessage), (e = this.getInput()) && (e.setAttribute("aria-invalid", !0), e.setAttribute("aria-describedBy", T["validation-message"]), re(e), I(e, T.inputerror))
        }, resetValidationMessage: function () {
            var e = Y.domCache.get(this);
            e.validationMessage && U(e.validationMessage), (e = this.getInput()) && (e.removeAttribute("aria-invalid"), e.removeAttribute("aria-describedBy"), q(e, T.inputerror))
        }, getProgressSteps: function () {
            return Y.domCache.get(this).progressSteps
        }, _main: function (e, t = {}) {
            var o, a, s, n = Object.assign({}, t, e);
            !n.backdrop && n.allowOutsideClick && x('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`');
            for (const p in n) s = p, He(s) || x('Unknown parameter "'.concat(s, '"')), n.toast && (a = p, De.includes(a)) && x('The parameter "'.concat(a, '" is incompatible with toasts')), a = p, Ie(a) && (s = a, o = Ie(a), o = '"'.concat(s, '" is deprecated and will be removed in the next major release. Please use "').concat(o, '" instead.'), X.includes(o) || (X.push(o), x(o)));
            $.currentInstance && $.currentInstance._destroy(), $.currentInstance = this;
            l = t, c = (e => {
                if (!(e = "string" == typeof e.template ? document.querySelector(e.template) : e.template)) return {};
                {
                    var t = e = e.content;
                    const a = Xe.concat(["swal-param", "swal-button", "swal-image", "swal-icon", "swal-input", "swal-input-option"]);
                    k(t.children).forEach(e => {
                        e = e.tagName.toLowerCase(), -1 === a.indexOf(e) && x("Unrecognized element <".concat(e, ">"))
                    })
                }
                return Object.assign((e => {
                    const a = {};
                    return k(e.querySelectorAll("swal-param")).forEach(e => {
                        _(e, ["name", "value"]);
                        var t = e.getAttribute("name");
                        let o = e.getAttribute("value");
                        "boolean" == typeof W[t] && "false" === o && (o = !1), "object" == typeof W[t] && (o = JSON.parse(o)), a[t] = o
                    }), a
                })(e), (e => {
                    const o = {};
                    return k(e.querySelectorAll("swal-button")).forEach(e => {
                        _(e, ["type", "color", "aria-label"]);
                        var t = e.getAttribute("type");
                        o["".concat(t, "ButtonText")] = e.innerHTML, o["show".concat(K(t), "Button")] = !0, e.hasAttribute("color") && (o["".concat(t, "ButtonColor")] = e.getAttribute("color")), e.hasAttribute("aria-label") && (o["".concat(t, "ButtonAriaLabel")] = e.getAttribute("aria-label"))
                    }), o
                })(e), (t = {}, (o = e.querySelector("swal-image")) && (_(o, ["src", "width", "height", "alt"]), o.hasAttribute("src") && (t.imageUrl = o.getAttribute("src")), o.hasAttribute("width") && (t.imageWidth = o.getAttribute("width")), o.hasAttribute("height") && (t.imageHeight = o.getAttribute("height")), o.hasAttribute("alt")) && (t.imageAlt = o.getAttribute("alt")), t), (o = {}, (t = e.querySelector("swal-icon")) && (_(t, ["type", "color"]), t.hasAttribute("type") && (o.icon = t.getAttribute("type")), t.hasAttribute("color") && (o.iconColor = t.getAttribute("color")), o.iconHtml = t.innerHTML), o), (e => {
                    const o = {}, t = e.querySelector("swal-input");
                    return t && (_(t, ["type", "label", "placeholder", "value"]), o.input = t.getAttribute("type") || "text", t.hasAttribute("label") && (o.inputLabel = t.getAttribute("label")), t.hasAttribute("placeholder") && (o.inputPlaceholder = t.getAttribute("placeholder")), t.hasAttribute("value")) && (o.inputValue = t.getAttribute("value")), (e = e.querySelectorAll("swal-input-option")).length && (o.inputOptions = {}, k(e).forEach(e => {
                        _(e, ["value"]);
                    ...
                    var o = {};
                    for (const n in t) {
                        var a = t[n], s = e.querySelector(a);
                        s && (_(s, []), o[a.replace(/^swal-/, "")] = s.innerHTML.trim())
                    }
                    return o
                })(e, Xe));
                var o
            })(u = e), (l = Object.assign({}, W, l, c, u)).showClass = Object.assign({}, W.showClass, l.showClass), l.hideClass = Object.assign({}, W.hideClass, l.hideClass);
            c = e = l;
            (i = c).inputValidator || Object.keys(Ke).forEach(e => {
                i.input === e && (i.inputValidator = Ke[e])
            }), c.showLoaderOnConfirm && !c.preConfirm && x("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://sweetalert2.github.io/#ajax-request"), (l = c).target && ("string" != typeof l.target || document.querySelector(l.target)) && ("string" == typeof l.target || l.target.appendChild) || (x('Target parameter is not valid, defaulting to "body"'), l.target = "body"), "string" == typeof c.title && (c.title = c.title.split("\n").join("<br />"));
            var i, r, l = c,
                c = !!(c = L()) && (c.remove(), q([document.documentElement, document.body], [T["no-backdrop"], T["toast-shown"], T["has-column"]]), !0);
            if (ue()) P("SweetAlert2 requires document to initialize"); else {
                var d = document.createElement("div");
                d.className = T.container, c && I(d, T["no-transition"]), H(d, pe), (c = "string" == typeof (c = l.target) ? document.querySelector(c) : c).appendChild(d), d = l, (r = O()).setAttribute("role", d.toast ? "alert" : "dialog"), r.setAttribute("aria-live", d.toast ? "polite" : "assertive"), d.toast || r.setAttribute("aria-modal", "true"), l = c, "rtl" === window.getComputedStyle(l).direction && I(L(), T.rtl);
                {
                    const m = O(), w = V(m, T.input), g = V(m, T.file),
                        h = m.querySelector(".".concat(T.range, " input")),
                        f = m.querySelector(".".concat(T.range, " output")), b = V(m, T.select),
                        y = m.querySelector(".".concat(T.checkbox, " input")), v = V(m, T.textarea);
                    w.oninput = R, g.onchange = R, b.onchange = R, y.onchange = R, v.oninput = R, h.oninput = () => {
                        R(), f.value = h.value
                    }, h.onchange = () => {
                        R(), h.nextSibling.value = h.value
                    }
                }
            }
            Object.freeze(e), $.timeout && ($.timeout.stop(), delete $.timeout), clearTimeout($.restoreFocusTimeout), u = {
                popup: O(),
                container: L(),
                actions: oe(),
                confirmButton: j(),
                ...
                progressSteps: ee()
            }, Y.domCache.set(this, u);
            var C, A, B, c, u, t = u;
            return Be(this, e), Y.innerParams.set(this, e), C = this, A = t, B = e, new Promise(e => {
                const o = e => {
                    C.closePopup({isDismissed: !0, dismiss: e})
                };
                var l, c, t, a, s, n, i, r, d, u, p, m, w;
                if (Fe.swalPromiseResolve.set(C, e), A.confirmButton.onclick = () => {
                    var e, t = B;
                    (e = C).disableButtons(), t.input ? ot(e, t, "confirm") : nt(e, t, !0)
                }, A.denyButton.onclick = () => {
                    var e, t = B;
                    (e = C).disableButtons(), t.returnInputValueOnDeny ? ot(e, t, "deny") : at(e, t, !1)
                }, A.cancelButton.onclick = () => {
                    var e = C, t = o;
                    e.disableButtons(), t(E.cancel)
                }, A.closeButton.onclick = () => o(E.close), y = A, e = o, Y.innerParams.get(n = C).toast ? (m = n, w = e, y.popup.onclick = () => {
                    var e = Y.innerParams.get(m);
                    e.showConfirmButton || e.showDenyButton || e.showCancelButton || e.showCloseButton || e.timer || e.input || w(E.close)
                }) : ((p = y).popup.onmousedown = () => {
                    p.container.onmouseup = function (e) {
                        p.container.onmouseup = void 0, e.target === p.container && (ct = !0)
                    }
                }, (u = y).container.onmousedown = () => {
                    u.popup.onmouseup = function (e) {
                        u.popup.onmouseup = void 0, e.target !== u.popup && !u.popup.contains(e.target) || (ct = !0)
                    }
                }, i = n, d = e, (r = y).container.onclick = e => {
                    var t = Y.innerParams.get(i);
                    ct ? ct = !1 : e.target === r.container && J(t.allowOutsideClick) && d(E.backdrop)
                }), l = C, y = $, e = B, c = o, y.keydownTarget && y.keydownHandlerAdded && (y.keydownTarget.removeEventListener("keydown", y.keydownHandler, {capture: y.keydownListenerCapture}), y.keydownHandlerAdded = !1), e.toast || (y.keydownHandler = e => {
                    var t, o, a = l, s = c, n = Y.innerParams.get(a);
                    if (n) if (n.stopKeydownPropagation && e.stopPropagation(), "Enter" === e.key) o = n, (t = e).isComposing || t.target && a.getInput() && t.target.outerHTML === a.getInput().outerHTML && (["textarea", "file"].includes(o.input) || (Ee(), t.preventDefault())); else if ("Tab" === e.key) {
                        var i = (a = e).target, r = ne();
                        let t = -1;
                        for (let e = 0; e < r.length; e++) if (i === r[e]) {
                            t = e;
                            break
                        }
                        a.shiftKey ? it(0, t, -1) : it(0, t, 1), a.stopPropagation(), a.preventDefault()
                    } else [...rt, ...lt].includes(e.key) ? (o = e.key, [j(), z(), D()].includes(document.activeElement) && (o = rt.includes(o) ? "nextElementSibling" : "previousElementSibling", o = document.activeElement[o]) && o.focus()) : "Escape" === e.key && (t = e, a = n, e = s, J(a.allowEscapeKey)) && (t.preventDefault(), e(E.esc))
                }, y.keydownTarget = e.keydownListenerCapture ? window : O(), y.keydownListenerCapture = e.keydownListenerCapture, y.keydownTarget.addEventListener("keydown", y.keydownHandler, {capture: y.keydownListenerCapture}), y.keydownHandlerAdded = !0), e = C, "select" === (y = B).input || "radio" === y.input) {
                    var g = e, h = y;
                    const v = O(), k = e => Qe[h.input](v, et(e), h);
                    G(h.inputOptions) || Q(h.inputOptions) ? (Z(j()), S(h.inputOptions).then(e => {
                        g.hideLoading(), k(e)
                    })) : "object" == typeof h.inputOptions ? k(h.inputOptions) : P("Unexpected type of inputOptions! Expected object, Map or Promise, got ".concat(typeof h.inputOptions))
                } else if (["text", "email", "number", "tel", "textarea"].includes(y.input) && (G(y.inputValue) || Q(y.inputValue))) {
                    Z(j());
                    {
                        var f = e, b = y;
                        const x = f.getInput();
                        U(x), S(b.inputValue).then(e => {
                            x.value = "number" === b.input ? parseFloat(e) || 0 : "".concat(e), N(x), x.focus(), f.hideLoading()
                        }).catch(e => {
                            P("Error in inputValue promise: ".concat(e)), x.value = "", N(x), x.focus(), f.hideLoading()
                        })
                    }
                }
                Je(B), t = $, a = B, s = o, n = ae(), U(n), a.timer && (t.timeout = new _e(() => {
                    s("timer"), delete t.timeout
                }, a.timer), a.timerProgressBar) && (N(n), setTimeout(() => {
                    t.timeout && t.timeout.running && de(a.timer)
                }));
                var e = A, y = B;
                if (!y.toast) J(y.allowEnterKey) ? (y.focusDeny && F(e.denyButton) ? (e.denyButton.focus(), 0) : y.focusCancel && F(e.cancelButton) ? (e.cancelButton.focus(), 0) : !y.focusConfirm || !F(e.confirmButton) || (e.confirmButton.focus(), 0)) && it(0, -1, 1) : document.activeElement && "function" == typeof document.activeElement.blur && document.activeElement.blur();
                setTimeout(() => {
                    A.container.scrollTop = 0
                })
            })
        }, update: function (t) {
            var e = O(), o = Y.innerParams.get(this);
            if (!e || p(e, o.hideClass.popup)) return x("You're trying to update the closed or closing popup, that won't work. Use the update() method in preConfirm parameter or show a new popup.");
            const a = {};
            Object.keys(t).forEach(e => {
                i.isUpdatableParameter(e) ? a[e] = t[e] : x('Invalid parameter to update: "'.concat(e, '". Updatable params are listed here: https://github.com/sweetalert2/sweetalert2/blob/master/src/utils/params.js\n\nIf you think this parameter should be updatable, request it here: https://github.com/sweetalert2/sweetalert2/issues/new?template=02_feature_request.md'))
            }), o = Object.assign({}, o, a), Be(this, o), Y.innerParams.set(this, o), Object.defineProperties(this, {
                params: {
            ...
            var e = Y.domCache.get(this), t = Y.innerParams.get(this);
            t && (e.popup && $.swalCloseEventFinishedCallback && ($.swalCloseEventFinishedCallback(), delete $.swalCloseEventFinishedCallback), $.deferDisposalTimer && (clearTimeout($.deferDisposalTimer), delete $.deferDisposalTimer), "function" == typeof t.didDestroy && t.didDestroy(), delete this.params, delete $.keydownHandler, delete $.keydownTarget, dt(Y), dt(Fe))
        }
    });
    let ut;
    ...
    class a {
        constructor(...e) {
            "undefined" != typeof window && (ut = this, e = Object.freeze(this.constructor.argsToParams(e)), Object.defineProperties(this, {
                params: {
                    value: e,
                    writable: !1,
                    enumerable: !0,
            ...
            }), e = this._main(this.params), Y.promise.set(this, e))
        }

        then(e) {
            return Y.promise.get(this).then(e)
        }

        finally(e) {
            return Y.promise.get(this).finally(e)
        }
    }

    Object.assign(a.prototype, e), Object.assign(a, qe), Object.keys(e).forEach(t => {
        a[t] = function (...e) {
            if (ut) return ut[t](...e)
        }
    }), a.DismissReason = E, a.version = "11.0.16";
    const i = a;
    return i.default = i
