    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0"><?php echo trans("Slider Ayarları") ?></h2>
        ...
        <div class="col-md-3 text-end">
            <a class="btn btn-primary" href="<?php echo e(siteUrl('design-settings/slider-settings/new-slider')); ?>"> Yeni Slider </a>
        </div>
    </div>
    <div class="content-body">
        <section id="basic-datatable" class="table">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <table class="datatables-basic table" id="slider-datatable">
                            <thead style="position: sticky; top: 0; z-index: 0">
                            <tr>
                                <th></th>
                                <th><?php echo trans("Sıra") ?></th>
                                <th><?php echo trans("Başlık") ?></th>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(themeAssets('assets/js/pages/slider-settings.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bekir/Desktop/admin/themes/admin/views/design-settings/slider-settings.blade.php ENDPATH**/ ?>