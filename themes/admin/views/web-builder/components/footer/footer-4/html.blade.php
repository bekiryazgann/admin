<footer class="bg-blue-500">
    <div class="lg:pt-16 pt-4">
        <div class="mx-auto py-4 lg:px-2 px-4 lg:gap-4 gap-6 max-w-7xl grid lg:grid-cols-5 grid-cols-1 border-b border-b-1 border-b-white pb-8">
            @foreach($data['menu'] as $menu1)
                <ul>
                    <li class="mb-2 lg:text-2xl text-lg font-bold text-white">
                        {{$menu1['title']}}
                    </li>
    ...
    <div class="bg-lue-500">
        <div class="mx-auto py-4 max-w-7xl px-2 flex items-center justify-between lg:flex-row flex-col">
            ...
            <p class="block text-white lg:mt-0 mt-2 lg:text-base text-xs">
                {{$data['copyright']}}
            </p>
            ...
            <div class="mx-auto lg:py-4 py-2 max-w-7xl px-2 flex items-center justify-center">
                <p class="flex items-center">
                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" class="mt-[2px]">
                        ...
                        <path d="M7.36644 9.68734H6.07822V8.23033H7.36644C7.79584 8.23033 7.96463 7.90355 8.00649 7.80363C8.04835 7.7037 8.15908 7.35262 7.85661 7.0488L6.75069 5.94287C6.26187 5.45541 6.11738 4.72758 6.38205 4.08887C6.64671 3.45152 7.26381 3.03832 7.95383 3.03832H8.28871V4.49667H7.95248C7.8107 4.49667 7.74993 4.59119 7.72698 4.64791C7.70402 4.70327 7.67971 4.814 7.77964 4.91392L8.88556 6.01984C9.51211 6.6464 9.69036 7.54302 9.35142 8.36267C9.01249 9.17962 8.25225 9.68734 7.36644 9.68734Z" fill="#2f71f0"/>
                    </svg>
